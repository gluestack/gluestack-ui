...
### Run the following command:
  ```bash
  npx gluestack-ui-nightly add useMediaQuery
  ```
</TabItem>
...
```ts
%%-- File: src/components/ui/utils/use-media-query/index.ts --%%
```
...
```ts
%%-- File: src/components/ui/utils/use-media-query/index.web.ts --%%
```
