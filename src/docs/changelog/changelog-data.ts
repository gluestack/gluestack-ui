...
v5 components are served from the \`main\` branch. The CLI automatically selects the correct branch based on the detected styling engine — no manual configuration needed.
