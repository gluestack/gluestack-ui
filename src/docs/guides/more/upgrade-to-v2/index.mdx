...
<br/>
1. **Initialize gluestack-ui v2**: `npx gluestack-ui-nightly@latest init`
2. **Setup Tailwind CSS**: `import "@/global.css"`
3. **Add All Components**: `npx gluestack-ui-nightly@latest add --all`
...
```
npx gluestack-ui-nightly@latest init
```
...
```jsx
npx gluestack-ui-nightly@latest add --all
```
...
```jsx
npx gluestack-ui-nightly@latest add heading
```
