...
<br/>
1. **Initialize gluestack-ui v2**: <InlineCode>{`${process.env.NEXT_PUBLIC_GLUESTACK_COMMAND || 'npx gluestack-ui'}@latest init`}</InlineCode>
2. **Setup Tailwind CSS**: `import "@/global.css"`
3. **Add All Components**: <InlineCode>{`${process.env.NEXT_PUBLIC_GLUESTACK_COMMAND || 'npx gluestack-ui'}@latest add --all`}</InlineCode>
...
<CodeBlock code={`${process.env.NEXT_PUBLIC_GLUESTACK_COMMAND || 'npx gluestack-ui'}@latest init`} language="bash" />
...
<CodeBlock code={`${process.env.NEXT_PUBLIC_GLUESTACK_COMMAND || 'npx gluestack-ui'}@latest add --all`} language="bash" />
...
<CodeBlock code={`${process.env.NEXT_PUBLIC_GLUESTACK_COMMAND || 'npx gluestack-ui'}@latest add heading`} language="bash" />
