...
<CodeBlock code="npx gluestack-ui-nightly upgrade" language="bash" />

For monorepos, please follow the manual installation guide instead.

This guide provides detailed manual steps to migrate from legacy gluestack-ui packages to the new gluestack-ui-nightly v3 ecosystem. Follow these steps carefully to ensure a smooth transition with minimal issues.

We’ll be releasing an official Gluestack monorepo template soon to make the process even easier.
