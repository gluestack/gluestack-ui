...
[gluestack VS Code Extension](https://marketplace.visualstudio.com/items?itemName=gluestack.gluestack-vscode) is specially crafted to streamline your development process when using the gluestack-ui v5. It provides a set of powerful features to accelerate your workflow and improve efficiency.
...
2. Open a project in Visual Studio Code that uses `gluestack-ui v5`.
