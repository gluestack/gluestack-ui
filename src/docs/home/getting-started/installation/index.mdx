...
```bash
yarn add @gluestack-ui-nightly/core @gluestack-ui-nightly/utils react-native-svg @gluestack-nightly/ui-next-adapter react-native-web react-native
```

OR

```bash
npm i @gluestack-ui-nightly/core @gluestack-ui-nightly/utils react-native-svg @gluestack-nightly/ui-next-adapter react-native-web react-native
```

For Next.js 14, it's recommended to use the `--legacy-peer-deps` flag due to peer dependency resolution issues.

```bash
npm i @gluestack-ui-nightly/core @gluestack-ui-nightly/utils react-native-svg @gluestack-nightly/ui-next-adapter react-native-web react-native --legacy-peer-deps
```
