...
Copy all the contents of the gluestack-utils folder from the <UtilsLink /> into your project's `@gluestack-ui-nightly/utils/` directory.
...
#### Step 5.4: Configure GluestackUIProvider in project
