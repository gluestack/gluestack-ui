...
**gluestack-ui v3** is a major upgrade designed to meet the needs of modern developers by enhancing performance, improving the developer experience, and offering greater flexibility. Here's why we're excited to release v2:

- **Performance Optimization**: gluestack-ui v3 is lightweight and efficient, ensuring fast load times and smooth performance across all devices.
...
- **No Extra Dependencies**: gluestack-ui v3 minimizes additional dependencies, making your projects leaner and easier to maintain.
...
- **No Default Primary Color**: Start with a non-opinionated design, as gluestack-ui v3 uses a default primary gray color that can be easily adjusted to fit your preferences.
...
- **Accessibility**: gluestack-ui v3 aims to provide a set of accessible components that work across different platforms and devices. The components have accessibility features such as ARIA attributes, keyboard navigation, and focus management.
- **Ease of Use**: gluestack-ui v3 components are designed to be easily customizable. They have clear and concise APIs that make integration into existing projects simple.
