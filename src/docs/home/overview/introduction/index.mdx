...
gluestack-ui v5 is built by the community, for the community. We welcome contributions of all kinds:
...
> Note: Upgrade to v5 [Click here](/ui/docs/guides/more/upgrade-to-v5).
