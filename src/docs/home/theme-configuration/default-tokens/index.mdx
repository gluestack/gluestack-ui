...
pageDescription: gluestack-ui v3 ships with default tokens, including colored tokens that provide access to theme values and flexibility to build and customize your own themed UI components.
...
Theming in `@gluestack-ui v3` is based on the [Styled System Theme Specification](https://github.com/system-ui/theme-specification).
