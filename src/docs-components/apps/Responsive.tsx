  ...
  return (
    <Box className="min-w-[70vw]">
      ...
      {ctaVisible && (
        <>
      {/* Bottom info section */}
      <Box className="flex flex-col md:flex-row -mt-12 mb-6 rounded-lg border border-border bg-background p-4 w-auto self-start">
        <Box className="flex-1">
          <NText className="text-foreground font-bold font-Inter text-xl">
            Give it a shot!
          </NText>

          {/* Desktop description */}
          <Box className="hidden md:flex">
            <NText className="text-muted-foreground font-Inter mt-2 md:max-w-[319px] text-base">
          ...
          {/* Mobile description */}
          <NText className="flex text-muted-foreground font-Inter mt-2 md:hidden md:max-w-[319px]">
          ...
          {/* Desktop button */}
          <Pressable
            className="hidden md:flex py-1 px-3 mt-5 border border-border rounded-sm bg-transparent flex-row items-center w-auto self-start transition-all duration-200 hover:border-muted focus:outline-none focus:ring-2 focus:ring-ring"
            onPress={() =>
              checkPlatform({
          ...
          >
            ...
            <NText className="text-foreground ml-2.5 text-sm">
              Open in new tab
            </NText>
          </Pressable>
          ...
          {/* Mobile button */}
          <Pressable
            className="flex md:hidden py-1 px-3 mt-5 border border-border rounded-sm bg-transparent flex-row items-center w-auto self-start transition-all duration-200 hover:border-muted focus:outline-none focus:ring-2 focus:ring-ring"
            onPress={() => {
              checkPlatform({
                android: updateIds?.android,
                ios: updateIds?.ios,
