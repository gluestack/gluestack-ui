...
//     theme,
//     componentExtendedConfig?.themes
//   );
...
// function parseAndExtractConfig(code, opts) {
//   try {
...
//       let filePath = opts?.filename.split('/');
...
//           // optional case
//           let componentConfigNode = args[2] ?? types.objectExpression([]);
//           let extendedThemeNode = args[3] ?? types.objectExpression([]);
...
//           let componentConfigNode = args[1] ?? types.objectExpression([]);
