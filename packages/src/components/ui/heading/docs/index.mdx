...
```jsx 
%%-- File: packages/src/components/ui/heading/index.tsx --%% 
```
...
```jsx 
%%-- File: packages/src/components/ui/heading/index.web.tsx --%% 
```
...
```jsx 
%%-- File: packages/src/components/ui/heading/styles.tsx --%% 
```
