...
```jsx 
%%-- File: packages/src/components/ui/checkbox/index.tsx --%% 
```
...
```jsx 
%%-- File: packages/src/components/ui/checkbox/index.web.tsx --%% 
```

### Step 3: Copy and paste the following code into styles.tsx in your project.

```jsx 
%%-- File: packages/src/components/ui/checkbox/styles.tsx --%% 
```
