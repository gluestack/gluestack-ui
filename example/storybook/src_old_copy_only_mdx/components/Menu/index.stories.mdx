...
import { AccessibleMenu } from './Menu';
...
<AppProvider>
  <CodePreview
    ...
    metaData={{
           ...
           <Wrapper>
            ...
            >
              <Menu.Content zIndex={100}>
                <Menu.Item>
                  <RNText style={{ padding: 12 }}>Arial</RNText>
                </Menu.Item>
                <Menu.Item>
                  <RNText style={{ padding: 12 }}>Nunito Sans</RNText>
                </Menu.Item>
                <Menu.Item>
                  <RNText style={{ padding: 12 }}>Roboto</RNText>
                </Menu.Item>
                <Menu.Item>
                  <RNText style={{ padding: 12 }}>Poppins</RNText>
                </Menu.Item>
                <Menu.Item>
                  <RNText style={{ padding: 12 }}>SF Pro</RNText>
                </Menu.Item>
                <Menu.Item>
                  <RNText style={{ padding: 12 }}>Helvetica</RNText>
                </Menu.Item>
                <Menu.Item isDisabled>
                  <RNText style={{ padding: 12 }}>Sofia</RNText>
                </Menu.Item>
                <Menu.Item>
                  <RNText style={{ padding: 12 }}>Cookie</RNText>
                </Menu.Item>
              </Menu.Content>
              <Menu.Backdrop />
            </Menu>
      ...
      scope: { Menu: AccessibleMenu, Wrapper, RNText, Pressable, View },
      argsType: {},
    }}
  />
</AppProvider>
  ...
  <Table>
    <Table.TBody>
      <Table.TR>
        ...
        <Table.TD>
          <Text>If open, closes the tooltip without delay.</Text>
        </Table.TD>
      </Table.TR>
      <Table.TR>
        <Table.TD>
      ...
      <Table.TR>
        ...
        <Table.TD>
          <Text>Moves focus to the next focusable element.</Text>
        </Table.TD>
      </Table.TR>
      <Table.TR>
        <Table.TD>
