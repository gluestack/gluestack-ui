...
Customizing tokens allows you to tailor the core design elements of the `@gluestack-ui/themed` library to match your project's unique visual identity.

1. **Clone Config**: Currently inorder to customize tokens you need to copy config and update the tokens as per your requirements. you can find default config file [here](https://github.com/gluestack/gluestack-ui/tree/main/packages/config). To customize tokens, follow these steps after cloning the config:
...
Customizing components allows you to fine-tune the appearance and behavior of individual UI components within the `@gluestack-ui/themed`.

1. **Clone Config**: Currently inorder to customize components theme you need to copy config and update the components theme as per your requirements. you can find default config file [here](https://github.com/gluestack/gluestack-ui/tree/main/packages/config).
...
1. **Clone Config**: Currently inorder to change animation you need to copy config and update the animation as per your requirements. you can find default config file [here](https://github.com/gluestack/gluestack-ui/tree/main/packages/config).
