...
The accessibility, interactivity and other features of the components are provided by `@gluestack-ui/react`. The styling of the components is done by using another library [gluestack-style](https://style.gluestack.io/). We can use customised styles, theme tokens, dark and light mode, breakpoints etc with the help of `@gluestack-style`
