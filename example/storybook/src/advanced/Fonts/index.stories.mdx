...
You can use this `styled` function which has the [font plugin](/ui/docs/plugins/fonts-plugin) added to it to style your components. For gluestack-ui components, we have used this styled function to style the components.
