...
gluestack-ui leverages the power of the [Animation plugin](/ui/docs/plugins/animation-plugin) from [gluestack.io/style](/style) to provide animations for a more engaging user experience. By default, all of our animated components are built using the [@legendapp/motion](https://legendapp.com/open-source/motion/), which provides declarative animations for React Native.
...
You can refer to [animation plugin](/ui/docs/plugins/animation-plugin) documentation for more details.
