...
```jsx
// import the styles
import { Root } from '../ui-components/Image/styled-components';
...
Default styling of the component can be found in the `ui-components/Image` file. For reference, you can view the [source code](https://github.com/gluestack/gluestack-ui/blob/development/example/storybook/src/ui-components/Image/index.tsx) of the styled `Image` component.
