...
import { Text, AlertDialog, CheckCircleIcon } from './AlertDialog';
...
An example of an AlertDialog component used for displaying important messages or prompts to the user in a dialog-style format.
