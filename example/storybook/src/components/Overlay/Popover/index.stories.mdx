...
import { Heading, Icon, HStack, VStack, Avatar } from './Popover';
import { Button, Box, CloseIcon, CircleIcon } from './Popover';
...
<AppProvider>
  <CodePreview
    ...
    metaData={{
      code: `
        <Box h='$80'>
        {/* PhoneIcon, Clock3Icon, MailIcon
          are imported from 'lucide-react-native' */}
          <Popover
            trigger={(triggerProps) => {
              return (
                <HStack>
