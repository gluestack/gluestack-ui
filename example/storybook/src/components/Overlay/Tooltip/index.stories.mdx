          ...
          trigger={(triggerProps) => {
            return (
                <Avatar.Group {...triggerProps}>
                 ...
                 <Avatar size="lg" color="$white" borderColor="$white" borderWidth="$0.5">+{remainingCount}</Avatar>
                </Avatar.Group>
            )
          }}
        >
         <Tooltip.Content bg="white" p="$5" maxWidth='$72'>
           <VStack boderRadius="$2" space='md'>
            ...
            <Center>
              <Text size="sm" lineHeight='$md'>Includes John, Sarah, Mike, Emily,</Text>
              <Text size="sm" lineHeight='$md'> and David</Text>
            </Center>
          </VStack>
         </Tooltip.Content> 
       </Tooltip>
...
`,
scope: { Avatar, Wrapper, HStack,Tooltip,Text,Box,Heading,Edit,Icon},
argsType: {},
}}
/>
    ...
    metaData={{
      ...
      return (
        <Tooltip 
          ...
          trigger={(triggerProps) => {
            return (         
            <Button  {...triggerProps} mt="$4" variant="solid">
        ...
        >
         <Tooltip.Content bg="white" boderRadius="$2">
           <Box minWidth={300} p="$5" minHeight={118}>
