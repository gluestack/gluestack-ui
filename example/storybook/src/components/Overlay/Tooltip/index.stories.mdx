...
We have a function called `createTooltip` which can be used to create a custom tooltip component. This function takes in a configuration object which contains the styled components that you want to use for the Tooltip You can refer [gluestack.io/style](/style) for more information on how to use styled components.
