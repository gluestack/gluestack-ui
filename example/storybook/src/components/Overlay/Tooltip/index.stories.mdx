            ...
            <Box h="$96" justifyContent="center">
              <AvatarGroup flexDirection='row'>
                ...
                {avatars.map((avatar, index) => {
                  return (
                    <Avatar key={index} size="lg" borderColor="$white" borderWidth="$2" bgColor={Avatarcolor} sx={{'_dark' : {borderColor: '$black'}}} >
                      <AvatarFallbackText>{Avataralt}</AvatarFallbackText>
                    </Avatar>
                  );
                })}
              </AvatarGroup>
