        ...
        >
         <Tooltip.Content bg="white" boderRadius="$2">
           <Box minWidth={300} p="$5" minHeight={118}>
             ...
             <Text size="sm">Includes John, Sarah, Mike, Emily, and David</Text>
           </Box>
         </Tooltip.Content> 
       </Tooltip>
      );
...
`,
scope: { Avatar, Wrapper, HStack,Tooltip,Text,Box,Heading},
argsType: {},
}}
/>
    ...
    metaData={{
      ...
      return (
        <Tooltip 
          ...
          trigger={(triggerProps) => {
            return (         
            <Avatar size="md" {...triggerProps}>
              <Edit  color="white" bg="#4F46E5"/>
            </Avatar>
            )
          }}
        >
...
`,
scope: { Avatar, Wrapper, HStack,Tooltip,Text,Box,Heading,Edit},
argsType: {},
}}
/>
