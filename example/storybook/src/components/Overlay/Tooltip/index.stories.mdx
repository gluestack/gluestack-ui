    ...
    metaData={{
      ...
      return (
        ...
        <Tooltip
          ...
          trigger={(triggerProps) => {
            return (
                <Avatar.Group {...triggerProps}>
                    {avatars.slice(0, 3).map((avatar, index) => {
                      return (
                        <Avatar key={index} size="lg" borderColor="$white" borderWidth="$0.5" bgColor={avatar.color}>
        ...
        >
         <Tooltip.Content bg="white" p="$5" maxWidth='$72'>
...
`,
scope: { Avatar, Wrapper, HStack,Tooltip,Text,Box,Heading, VStack, Center},
argsType: {},
}}
/>
...
`,
scope: { Avatar, Wrapper, HStack,Tooltip,Text,Box,Heading,Edit,Command,Icon},
argsType: {},
}}
/>
...
<AppProvider>
  <CodePreview
    ...
    metaData={{
      ...
      return (
         <Wrapper>
            <Box h="$96" justifyContent="center" boderRadius="$2">
        <Tooltip
          placement={"top"}
          trigger={(triggerProps) => {
            return (
            <Button  {...triggerProps}  mt="$4" variant="solid" bg="$error700"  borderColor="$backgroundLight300">
             <Button.Text>Delete</Button.Text>
            </Button>
            )
          }}
        >
         <Tooltip.Content bg="white" boderRadius="$2">
           <Box p="$5">
             <Text size="sm">You do not have permission to delete</Text>
           </Box>
         </Tooltip.Content>
       </Tooltip>
           </Box>
...
`,
scope: { Avatar, Wrapper, HStack,Tooltip,Text,Box,Heading,Edit,Button},
argsType: {},
}}
/>
