...
Default styling of all these components can be found in the `components/Tabs` file. For reference, you can view the [source code](https://github.com/gluestack/universa11y/blob/development/example/storybook/src/ui-components/Tabs/index.tsx) of the styled `Tabs` components.
