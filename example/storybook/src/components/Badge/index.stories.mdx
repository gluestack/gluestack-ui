...
```jsx
// import the styles
import { Root, Text, Icon } from '../ui-components/Badge/styled-components';
...
Default styling of the component can be found in the `ui-components/Badge` file. For reference, you can view the [source code](https://github.com/gluestack/gluestack-ui/blob/development/example/storybook/src/ui-components/Badge/index.tsx) of the styled `Badge` component.
