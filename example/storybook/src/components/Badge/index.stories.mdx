...
```jsx
// import the styles
import { Root, Text, Icon } from './components/Badge';
...
Default styling of the component can be found in the `components/Badge` file. For reference, you can view the [source code](https://github.com/gluestack/universa11y/blob/development/example/storybook/src/components/styled-components/badge/index.tsx) of the styled `Badge` component.
