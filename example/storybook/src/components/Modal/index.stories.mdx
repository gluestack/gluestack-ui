...
Default styling of all these components can be found in the `components/Modal` file. For reference, you can view the [source code](https://github.com/gluestack/gluestack-ui/blob/development/example/storybook/src/ui-components/Modal/index.tsx) of the styled `Modal` components.
