...
import { Root, Content } from '../ui-components/Tooltip/styled-components';
...
Default styling of all these components can be found in the `components/Tooltip` file. For reference, you can view the [source code](https://github.com/gluestack/gluestack-ui/blob/development/example/storybook/src/ui-components/Tooltip/index.tsx) of the styled `Tooltip` components.
