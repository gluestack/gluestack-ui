...
Default styling of all these components can be found in the `components/core/text-area` file. For reference, you can view the [source code](https://github.com/gluestack/gluestack-ui/blob/development/example/storybook/src/components/TextArea/index.tsx) of the styled `TextArea` components.
