...
<AppProvider>
  <CodePreview
    ...
    metaData={{
      code: `
<Menu mt="$4" variant="solid">
   <Menu.Text>Menu</Menu.Text>
 </Menu>
<Menu mt="$4" variant="outline">
   <Menu.Text>Menu</Menu.Text>
 </Menu>
<Menu mt="$4" variant="link">
   <Menu.Text>Menu</Menu.Text>
 </Menu>
    `,
      transformCode: (code) => {
...
<AppProvider>
  <CodePreview
    ...
    metaData={{
      code: `
<Menu.Group direction="row">
  <Menu>
    <Menu.Text>Menu 1</Menu.Text>
  </Menu>
  <Menu bg="$blue500">
    <Menu.Text>Menu 2</Menu.Text>
  </Menu>
  <Menu>
    <Menu.Text>Menu 3</Menu.Text>
  </Menu>
</Menu.Group>
   `,
      transformCode: (code) => {
...
<AppProvider>
 ...
 <Menu>
   ...
   <Menu.Text>LeftIcon</Menu.Text>
 </Menu>
 <Menu variant="solid" mt="$2">
   <Menu.Text>RightIcon</Menu.Text>
...
function App () {
  ...
  return (
    <Wrapper>
      ...
      >
        <Menu.Spinner color="white" mr="$2" />
        <Menu.Text>Submitting</Menu.Text>
      </Menu>
    </Wrapper>
  );
    }`,
