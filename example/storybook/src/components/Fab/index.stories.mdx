  ...
  <Table>
    ...
    <Table.TBody>
      ...
      <Table.TR>
        ...
        <Table.TD>
          <Text>To manually set hover to the fab.</Text>
        </Table.TD>
      </Table.TR>
      <Table.TR>
        <Table.TD>
        ...
        <Table.TD>
          <Text>To manually set pressable state to the fab.</Text>
        </Table.TD>
      </Table.TR>
      <Table.TR>
        <Table.TD>
        ...
        <Table.TD>
          <Text>To manually set focused state to the fab.</Text>
        </Table.TD>
      </Table.TR>
      <Table.TR>
        <Table.TD>
        ...
        <Table.TD>
          <Text>To manually set disable to the fab.</Text>
        </Table.TD>
      </Table.TR>
    </Table.TBody>
  </Table>
...
```jsx
// import the styles
import { Root, Label } from '../ui-components/Fab/styled-components';
...
Default styling of all these components can be found in the `components/Fab` file. For reference, you can view the [source code](https://github.com/gluestack/gluestack-ui/blob/development/example/storybook/src/ui-components/Fab/index.tsx) of the styled `Fab` components.
