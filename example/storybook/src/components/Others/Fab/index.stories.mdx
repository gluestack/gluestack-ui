    ...
    metaData={{
      code: `
        ...
        >
          ...
          <Fab bg="$black" p='$3' h='$9' w='$9' position="relative" bottom='1%' left='50%'>
            <AddIcon/>
          </Fab>
        </Box>
      `,
      ...
      code: `
        ...
        >
          ...
          <Box mx='$6'>
            ...
            <Text size='sm' mt='$1.5' color='$trueGray900'>
              Rs 146(Rs.24.33/pc)
            </Text>
            <Text my='$1.5' size='xs' fontWeight='bold' color='$trueGray900'>
              DETAILS
            </Text>
            <Text size='xs' lineHeight='xs' mb='$1.5' color='$trueGray900'>
            ...
            <Text mb='$1.5' size='xs' color='$pink600' fontWeight='$bold'>
              READ MORE
            </Text>
          </Box>
