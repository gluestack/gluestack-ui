        ...
        >
          <VStack space='md'>
            <Box w='100%' flexDirection='row'>
              ...
              <VStack pt='$0.5'>
                <Heading color='$trueGray900' size='xs' fontStyle='regular'>
                  Kevin James
                </Heading>
    ...
    metaData={{
      code: `
        ...
        >
          ...
          <Fab bg="$black" p='$3' h={36} w={36} position="relative" bottom='1%' left='50%'>
            <AddIcon/>
          </Fab>
        </Box>
      `,
    ...
    metaData={{
      code: `
        ...
        >
          ...
          <Box mx='$6'>
            <Heading size='sm' mt='$4' color='$trueGray900'>
              Fresho Orange - Imported (Loose)
            </Heading>
            <Text size='sm' mt={6} color='$trueGray900'>
              Rs 146(Rs.24.33/pc)
            </Text>
            <Text my={6} size='xs' fontWeight='$bold' color='$trueGray900'>
              DETAILS
            </Text>
            <Text size='xs' fontWeight='normal' lineHeight='xs' mb={6} color='$trueGray900'>
            ...
            <Text mb={6} size='xs' color='$pink600' fontWeight='$bold'>
              READ MORE
            </Text>
          </Box>
          <Fab bg='$pink600' size='lg' right='$3' bottom='15%'>
            <ShoppingIcon/>
          </Fab>
        </Box>
      `,
