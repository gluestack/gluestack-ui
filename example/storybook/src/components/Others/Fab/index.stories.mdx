                  ...
                  {data.map((chatData)=>{
                    return (
                      <HStack space='sm' alignItems='center'>
                        ...
                        <VStack>
                          <Heading color='$trueGray900' size='xs' lineHeight='$lg'>
                            {chatData.name}
                          </Heading>
                          <Text color='$trueGray900' fontSize='$xs' lineHeight='$xs'>
                            {chatData.msg}
                          </Text>
                        </VStack>
                      </HStack>
      ...
      code: `
        ...
        >
          <Fab bg="$indigo600" height="$9" top='$4'>
            <Icon as={SearchIcon} color='$gray50' h='$4' w='$4'/>
          ...
          <VStack space='lg'>
            <Box>
              ...
              <Heading size='sm' lineHeight='$md' color='$black'>
                Benefits of Oranges
              </Heading>
              <Text fontSize='$xs' lineHeight='$xs' mt='$1.5' color='$black'>
                Oranges are a great source of vitamin C, which is essential for a healthy immune system.
              </Text>
              <HStack space='sm' mt='$3' h='$5'>
                <Text fontSize='$xs' lineHeight='$xs' color='$black'>
                  Wade Warrem
                </Text>
