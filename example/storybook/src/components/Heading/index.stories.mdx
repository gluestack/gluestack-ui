...
```jsx
// import the styles
import { Root } from './components/Heading';
...
Default styling of the component can be found in the `components/Heading` file. For reference, you can view the [source code](https://github.com/gluestack/universa11y/blob/development/example/storybook/src/components/styled-components/heading/index.tsx) of the styled `Heading` component.
