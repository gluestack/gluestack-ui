...
```jsx
// import the styles
import { Root } from '../ui-components/Heading/styled-components';
...
Default styling of the component can be found in the `ui-components/Heading` file. For reference, you can view the [source code](https://github.com/gluestack/gluestack-ui/blob/development/example/storybook/src/ui-components/Heading/index.tsx) of the styled `Heading` component.
