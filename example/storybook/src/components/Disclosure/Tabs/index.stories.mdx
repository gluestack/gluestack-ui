...
We have a function called createTabs which can be used to create a custom tabs component. This function takes in a configuration object which contains the styled components that you want to use for the Tabs You can refer [gluestack.io/style](https://gluestack.io/style) for more information on how to use styled components.

You can read more on how to animate components [here](https://gluestack.io/ui/docs/advanced/animations).

### Usage

Default styling of all these components can be found in the `components/core/tabs` file. For reference, you can view the [source code](https://github.com/gluestack/gluestack-ui/blob/main/packages/themed/src/components/Tabs/index.tsx) of the styled `Tabs` components.
