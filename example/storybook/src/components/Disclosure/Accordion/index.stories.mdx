    ...
    >
      ...
      >
        ...
        <AccordionContent mt="$0" pt="$2" sx={{
          ...
          <AccordionContentText>
            A controlled accordion is one where the expanded state of the
            accordion is controlled by the value prop. You can make it
            controlled by passing the value prop to the Accordion component and
            setting the onValueChange prop to update the value prop.
          </AccordionContentText>
        </AccordionContent>
      </AccordionItem>
    </Accordion>
