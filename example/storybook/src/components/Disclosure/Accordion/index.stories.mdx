    ...
    <Table>
      ...
      <Table.TBody>
        ...
        <Table.TR>
          <Table.TD>
            <Table.TText>
              <InlineCode>collapsible</InlineCode>
            </Table.TText>
          </Table.TD>
          <Table.TD>
        ...
        <Table.TR>
          <Table.TD>
            <Table.TText>
              <InlineCode>dir</InlineCode>
            </Table.TText>
          </Table.TD>
          <Table.TD>
            <Table.TText>"ltr" | "rtl"</Table.TText>
          </Table.TD>
          <Table.TD>
            <Table.TText>"ltr"</Table.TText>
          </Table.TD>
          <Table.TD>
            <Table.TText>{`The reading direction of the accordion when applicable. If omitted, assumes LTR (left-to-right) reading mode.`}</Table.TText>
          </Table.TD>
        </Table.TR>
        <Table.TR>
          <Table.TD>
