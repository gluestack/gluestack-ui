...
import { LinkTemp as Link, ArrowUpRightIcon, Icon, HStack, Text } from './Link';
...
```bash
npx gluestack-ui@latest update link
```
          ...
          <HStack>
            ...
            >Design inspiration from </Text>
              <Link href="https://gluestack.io/" isExternal>
                <Link.Text size="lg">pinterest.com</Link.Text>
              </Link>
          </HStack>
`,
transformCode: (code) => {
...
scope: { Link, Wrapper, ArrowUpRightIcon, Icon, HStack, Text },
argsType: {},
}}
/>
      ...
      code: `
        <HStack>
              ...
              <Link href="https://gluestack.io/" isExternal>
                ...
                <Link.Text size="lg">Pinterest</Link.Text>
