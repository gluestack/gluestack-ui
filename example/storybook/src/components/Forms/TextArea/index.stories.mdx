...
description: The Textarea component helps create multi-line text inputs.

pageTitle: TextArea

pageDescription: The Textarea component helps create multi-line text inputs.
...
```bash
npx gluestack-ui add text-area
```
