...
<AppProvider>
  <CodePreview
    ...
    metaData={{
      code: `
          <VStack space="md">
              <Switch  trackColor={{ false: "#D4D4D4", true: "#4F46E5" }}   />
              <Switch   trackColor={{ false: "#D4D4D4", true: "#D97706" }}/>
              <Switch   trackColor={{ false: "#D4D4D4", true: "#059669" }}/>
              <Switch   trackColor={{false:"#D4D4D4",true:"#C026D3"}}/>
          </VStack>
     `,
      transformCode: (code) => {
        return transformedCode(code);
