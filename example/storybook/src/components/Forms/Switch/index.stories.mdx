...
import { Switch, VStack, Text, HStack } from './Switch';
...
<AppProvider>
  <CodePreview
    ...
    metaData={{
      code: `
         <HStack space="md">
             <Switch isDisabled={true} isChecked={true} trackColor={{ false:"$trueGray300", true:"$darkBlue600" }}/>
...
<AppProvider>
  <CodePreview
    ...
    metaData={{
      code: `
         <Text size="sm" color="$error600">Invalid state is under discussion</Text>
     `,
      scope: {
        Wrapper,
        Switch,
...
<AppProvider>
  <CodePreview
    ...
    metaData={{
      code: `
             <VStack space="md">
                   <Switch size="sm" isChecked={true}/>
                   <Switch isChecked={true}/>
                   <Switch size="lg" isChecked={true}/> 
              </VStack>
     `,
      scope: {
        Wrapper,
...
<AppProvider>
  <CodePreview
    ...
    metaData={{
      code: `
             <VStack space="md">
                   <Switch isChecked={true}  trackColor={{ false: "#D4D4D4", true: "#4F46E5" }} />
                   <Switch isChecked={true}  trackColor={{ false: "#D4D4D4", true: "#D97706" }}/>
                   <Switch isChecked={true}  trackColor={{ false: "#D4D4D4", true: "#059669" }}/> 
                   <Switch isChecked={true}  trackColor={{false:"#D4D4D4",true:"#C026D3"}}/>
              </VStack>
     `,
      scope: {
        Wrapper,
