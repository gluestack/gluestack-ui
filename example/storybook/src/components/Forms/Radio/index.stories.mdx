...
<AppProvider>
  <CodePreview
    ...
    metaData={{
      code: `
        function App() {
          const [values, setValues] = React.useState("left");
          return (
            <Radio.Group value={values} onChange={setValues}>
              <HStack space="2xl">
                <Radio value="left" size="md">
                  <Radio.Indicator mr='$2'>
                    <Radio.Icon as={CircleIcon} />
                  </Radio.Indicator>
                </Radio>
                <Radio value="right" size="md">
                  <Radio.Indicator mr='$2'>
                    <Radio.Icon as={CircleIcon} />
                  </Radio.Indicator>
                </Radio>
...
<AppProvider>
  <CodePreview
    ...
    metaData={{
      ...
      scope: { Wrapper, Center, VStack, Radio, CircleIcon, useState },
      argsType: {},
    }}
  />
</AppProvider>
...
<AppProvider>
  <CodePreview
    ...
    metaData={{
      ...
      `,
      transformCode: (code) => {
        return transformedCode(code, 'function', 'RadioGroup');
      },
