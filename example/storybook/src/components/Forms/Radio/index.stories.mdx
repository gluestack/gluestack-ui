...
<AppProvider>
  <CodePreview
    ...
    metaData={{
      code: `
<Radio.Group>
  <Radio isInvalid={true}  value="invalid" mb="$2">
    <Radio.Indicator>
      <Radio.Icon>
        <CircleIcon />
      </Radio.Icon>
  ...
  <Radio isReadOnly={true} value="readonly" mb="$2">
    <Radio.Indicator>
      <Radio.Icon>
        <CircleIcon />
      </Radio.Icon>
  ...
  <Radio isDisabled={true}  value="disabled" mb="$2">
    <Radio.Indicator>
      <Radio.Icon>
        <CircleIcon />
      </Radio.Icon>
  ...
  <Radio isChecked={true} value="checked" mb="$2">
    <Radio.Indicator>
      <Radio.Icon>
        <CircleIcon />
      </Radio.Icon>
