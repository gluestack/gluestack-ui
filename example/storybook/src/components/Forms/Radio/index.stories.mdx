    ...
    metaData={{
      ...
      function App () {
          ...
          return (
                   <Radio.Group value={values} onChange={setValues}>
        <VStack space="2xl">
          <Radio value="Read-only" size="lg" >
            <Radio.Indicator>
              <Radio.Icon>
                <CircleIcon  />
              </Radio.Icon>
            </Radio.Indicator>
            <Radio.Label>Read-only</Radio.Label>
          </Radio>
          <Radio value="Write" size="lg">
            <Radio.Indicator>
              <Radio.Icon>
                <CircleIcon />
              </Radio.Icon>
            </Radio.Indicator>
            <Radio.Label>Write</Radio.Label>
          </Radio>
          <Radio value="Restricted" size="lg">
            <Radio.Indicator>
              <Radio.Icon>
                <CircleIcon />
              </Radio.Icon>
            </Radio.Indicator>
            <Radio.Label>Restricted</Radio.Label>
          </Radio>
        </VStack>
      </Radio.Group>
                )
    ...
    metaData={{
      ...
      function App () {
        ...
        <Box>
          ...
          <Text size="sm" ml="$8">Extra serivices included</Text>
        </Box>
        <Box>
          <Radio value="Write" size="lg">
            <Radio.Indicator>
          ...
          <Text size="sm" ml="$8">Nothing extra included</Text>
        </Box>
        </VStack>
      </Radio.Group>
                )
        ...
        <VStack space="sm">
          ...
          <Radio value="Wednesday" size="lg">
            ...
            <Radio.Label>Wednesday</Radio.Label>
              ...
              <Text size="sm" color="$textLight500">Choose a time slot for the meeting</Text>
           </VStack>
`,
transformCode: (code) => {
return transformedCode(code);
                    ...
                    <Radio.Group value={values} onChange={setValues} >
                        <VStack space="lg">
                            <Radio value="Monday" size="lg" >
                              ...
                              <Radio value="Tuesday" size="lg" isChecked={true}>
...
`,
      ...
      scope: { Radio, VStack, Wrapper, GluestackText: Text, CircleIcon },
      argsType: {},
    }}
  />
</AppProvider>
