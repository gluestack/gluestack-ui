          ...
          return (
            <Wrapper>
              <Box
                ...
                sx={{
                  _dark:{
                    borderWidth:'$1', borderRadius:'$lg', borderColor:'$borderDark600'
                  }
                }}
              >
                <VStack space='xl'>
                  ...
                  <VStack space='xs'>
                    ...
                    <Input textAlign='center'>
                      ...
                      <Input.Icon pr='$3'>
                        ...
                        <Icon as={showPassword ? EyeIcon : EyeOffIcon} onClick={handleState} color='$darkBlue500'/>
                      </Input.Icon>
                    </Input>
                  </VStack>
                  <Button
...
=======
      ...
      `,
>>>>>>> 69f8fca45099048acfa8ea31cadd1025c179a0ee
      transformCode: (code) => {
        return transformedCode(code);
      },
      scope: {
