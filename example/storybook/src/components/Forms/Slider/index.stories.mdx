...
For customizing the Slider, you have to map styled view to Slider You can refer [gluestack.io/style](https://style.gluestack.io/styleon on how to use styled components.
