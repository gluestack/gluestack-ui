...
import { LightbulbIcon, Icon } from './Slider';
  ...
  return (
    ...
    <Wrapper w="$80">
     ...
     <Wrapper w="$80">
      ...
      <Wrapper w="$80">
        <Slider defaultValue={45} isDisabled>
          <Slider.Track>
            <Slider.FilledTrack />
          </Slider.Track>
          <Slider.Thumb />
...
`,
      scope: { Wrapper, Slider, Center, VStack },
      argsType: {},
    }}
  />
</AppProvider>
...
function App(){
  return (
    ...
    <Wrapper w="$80">
     ...
     <Wrapper w="$80">
        <Slider defaultValue={46} size="md">
          <Slider.Track>
            <Slider.FilledTrack />
          </Slider.Track>
          <Slider.Thumb />
     ...
     <Wrapper w="$80">
        <Slider defaultValue={48} size="lg">
          <Slider.Track>
            <Slider.FilledTrack />
          </Slider.Track>
          <Slider.Thumb />
...
`,
      scope: { Wrapper, Slider, Center, LightbulbIcon, Icon, Text, VStack },
      argsType: {},
    }}
  />
</AppProvider>
