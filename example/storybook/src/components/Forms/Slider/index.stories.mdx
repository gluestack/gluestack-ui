...
For customizing the Slider, you have to map styled view to Slider You can refer [gluestack.io/style](/style) for more information on how to use styled components.
