...
function App(){
  return (
    <VStack space="4xl">
    <Center w="$80">
        <Slider defaultValue={45} sliderTrackHeight={4} isPressed>
          <Slider.Track >
            <Slider.FilledTrack />
          </Slider.Track>
          <Slider.Thumb />
     ...
     <Center w="$80">
        <Slider defaultValue={35} sliderTrackHeight={4}>
          <Slider.Track>
            <Slider.FilledTrack />
          </Slider.Track>
          <Slider.Thumb />
     ...
     <Center w="$80">
      ...
      <Center w="$80">
        <Slider defaultValue={45} isDisabled sliderTrackHeight={4}>
          <Slider.Track>
            <Slider.FilledTrack />
          </Slider.Track>
          <Slider.Thumb />
    ...
    <Center w="$72">
        <Slider
          ...
          <Slider.Track>
           ...
           <Slider.Thumb   borderWidth="0" bg="$amber600" p='$1' sx={{
              ':active': {
                outlineColor: '$amber500',
              },
            }}>
...
`,
      scope: { Center, Slider, LightbulbIcon, Icon, Text, VStack },
      argsType: {},
    }}
  />
</AppProvider>
...
function App(){
  ...
  return (
    <VStack space="2xl">
    <Box>
    <Text textAlign="center">sliderValue - {sliderValue}</Text>
