    ...
    metaData={{
      ...
      <FormControl>
        <HStack space='md'>
          ...
          <Button px='$3'>
            <Button.Text fontSize='$sm' fontWeight='$medium'>Next</Button.Text>
          </Button>
        </HStack>
        <FormControl.Error mt='$2'>
          <FormControl.Error.Text fontSize='$sm' lineHeight='$md'>
    ...
    metaData={{
      code: `
        <FormControl flexDirection='row'>
          <Button bg='$red700' mr='$4' py='$2.5' px='$3' h={42}>
            <Button.Text color='$text50' fontSize='$sm' fontWeight='$medium'>
              Delete
            </Button.Text>
          </Button>
          <Button variant='outline' borderColor='$trueGray300' py='$2.5' px='$3' h={42}>
