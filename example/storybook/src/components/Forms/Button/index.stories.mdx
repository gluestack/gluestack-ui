...
import { TableContainer, InlineCode } from '@gluestack/design-system';
...
We have outlined the various features that ensure the Button component is accessible to all users, including those with disabilities. These features help ensure that your application is inclusive and meets accessibility standards.
...
<AppProvider>
  <CodePreview
    ...
    metaData={{
      code: `
        <Button.Group direction="row" isAttached>
          <Button>
      ...
      code: `
        <Button.Group isAttached>
          ...
          <Button variant="outline" size='xs' borderColor='$backgroundLight300'>
            <Icon as={ThreeDotsIcon} color='$coolGray500'/>
          </Button>
        </Button.Group>
      `,
      transformCode: (code) => {
