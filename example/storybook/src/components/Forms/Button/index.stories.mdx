...
<AppProvider>
  <CodePreview
    ...
    metaData={{
      ...
      scope: { Button, ButtonText, ButtonIcon, Wrapper, Spinner },
      argsType: {},
    }}
  />
</AppProvider>
...
<AppProvider>
  <CodePreview
    ...
    metaData={{
      code: `
      <ButtonGroup direction="row" space="md">
        <Button>
   ...
   `,
      ...
      scope: { Button, ButtonText, ButtonIcon, ButtonGroup, Wrapper },
      argsType: {},
    }}
  />
</AppProvider>
    ...
    metaData={{
      code: `
        <HStack  p='$12'  alignItems='center'  borderColor='$backgroundLight300'
          ...
          <ButtonGroup direction="row" maxHeight='$10'>
