...
description: A button component is a graphical user interface element that enables users to act by clicking or tapping. A button is mainly used for indicating an action, submitting a data, opening a modal etc.
...
A button group incorporates multiple button components, providing a cohesive and organized interface for selecting various actions or options.
    ...
    metaData={{
      code: `
        <ButtonGroup isAttached>
          ...
          <Button px="$3" variant="outline" size='xs' borderColor='$backgroundLight300' sx={{
             _dark:{
            borderColor:'$backgroundDark700'
            }
          }}>
            <ButtonIcon as={AddIcon} color="$textLight900" sx={{
              _dark:{
                color:'$textDark300'
                }
              }}/>
