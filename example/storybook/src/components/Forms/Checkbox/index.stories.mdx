...
We have outlined the various features that ensure the Checkbox component is accessible to all users, including those with disabilities. These features help ensure that your application is inclusive and meets accessibility standards.
           ...
           return (
             <Wrapper>
               <HStack space="2xl">
                  ...
                  <Checkbox  size="md">
                    <Checkbox.Indicator isChecked={state.option2} onChange={onChangeOption2}>
                      <Checkbox.Icon as={CheckIcon}/>
                    </Checkbox.Indicator>
        ...
        return (
            <Wrapper>
                  <Checkbox size="md"  onChange={handleSubmit}>
                    <Checkbox.Indicator  ref={checkboxRef}>
                        <Checkbox.Icon as={CheckIcon}/>
                    </Checkbox.Indicator>
                     <Checkbox.Label>Apartments</Checkbox.Label>
                  </Checkbox>
