    ...
    metaData={{
      code: `
        function App(){
           ...
           return (
                <VStack space="3xl">
                  <Checkbox   isChecked={state.option1} onChange={onChangeOption1} >
                        <Checkbox.Indicator mr="$2">
                          <Checkbox.Icon as={CheckIcon}/>
                        </Checkbox.Indicator>
                        <Checkbox.Label>Framer</Checkbox.Label>
                  </Checkbox>
                  <Checkbox  isChecked={state.option2} onChange={onChangeOption2} >
                      <Checkbox.Indicator mr="$2">
                        <Checkbox.Icon as={CheckIcon}/>
                      </Checkbox.Indicator>
                      <Checkbox.Label>Invision Studio</Checkbox.Label>
                  </Checkbox>
                  <Checkbox  isChecked={state.option3} onChange={onChangeOption3}>
                    <Checkbox.Indicator mr="$2">
                      <Checkbox.Icon as={CheckIcon}/>
                    </Checkbox.Indicator>
