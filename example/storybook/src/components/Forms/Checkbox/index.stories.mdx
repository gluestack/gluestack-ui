...
import { Center, VStack, Text as CheckboxText, HStack } from './Checkbox';
...
<HStack>
<Text size="xs" ml="35px">Subscribe to updates from the Design Feed</Text></HStack>
      <VStack>
      <HStack>
<Checkbox >
  <Checkbox.Indicator>
...
<HStack>
<Text size="xs" ml="35px">Subscribe to updates from the Marketing Feed</Text></HStack></VStack>
</VStack>
`,
      transformCode: (code) => {
        return transformedCode(code);
...
<Text size="lg">Sign up for newsletters</Text>
...
<Text size="sm" color="#737373">
  Subscibe to newsletters for updates
</Text>
...
`,
      ...
      scope: { Checkbox, Wrapper, Center, CheckIcon, Icon, Text, VStack },
      argsType: {},
    }}
  />
</AppProvider>
...
<VStack space="md">
 ...
 <Checkbox justifyContent='right' isChecked={true} >
 <HStack space="lg">
