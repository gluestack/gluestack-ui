...
<VStack space="md">
 <Checkbox justifyContent='left' defaultIsChecked size="lg">
  <Checkbox.Indicator bgColor="#005DB4" >
 <Icon as={CheckIcon} color="#FAFAFA"/>
   </Checkbox.Indicator>
    ...
    metaData={{
      ...
      <VStack space="md">
          <VStack> 
            ...
            <HStack >
              <Text size="sm" ml="35px">Subscribe to updates from the Design Feed</Text>
            </HStack>
          </VStack>
          <VStack >
            <HStack>
            ...
            <HStack>
             <Text size="sm" ml="35px">Subscribe to updates from the Marketing Feed</Text>
            </HStack>
          </VStack>
        </VStack>
`,
...
<Checkbox size="lg">
  <Checkbox.Indicator bgColor="#005DB4" borderColor="#005DB4">
   <Icon as={CheckIcon}  color="#FAFAFA"/>
  </Checkbox.Indicator>
</Checkbox>
<Checkbox size="lg">
  <Checkbox.Indicator bgColor="#005DB4" borderColor="#005DB4">
   <Icon as={MinusIcon}  color="#FAFAFA"/>
  </Checkbox.Indicator>
</Checkbox>
</HStack>
`,
