...
import { Checkbox, CheckIcon, Icon, Text, MinusIcon } from './Checkbox';
import {
  Center,
  VStack,
  Text as CheckboxText,
  HStack,
  Heading,
} from './Checkbox';
...
<AppProvider>
  <CodePreview
    ...
    metaData={{
      code: `
<VStack space="3xl">
 <Checkbox justifyContent='left' defaultIsChecked size="lg">
  <Checkbox.Indicator bgColor="$darkBlue600" >
 <Icon as={CheckIcon} color="$backgroundLight50"/>
   </Checkbox.Indicator>
  <Checkbox.Label>Framer</Checkbox.Label>
</Checkbox>
<Checkbox justifyContent='left' size="lg">
  <Checkbox.Indicator>
    <Checkbox.Icon>
      <Icon as={CheckIcon} />
    </Checkbox.Icon>
...
`,
      ...
      scope: { Checkbox, Wrapper, Center, CheckIcon, Icon, VStack },
      argsType: {},
    }}
  />
</AppProvider>
...
<Checkbox defaultIsChecked size="lg">
  <Checkbox.Indicator bgColor="$primary600">
   <Icon as={CheckIcon} color="$backgroundLight50"/>
  </Checkbox.Indicator>
  ...
  <CodePreview
    ...
    metaData={{
      ...
      <VStack space="md">
            ...
            <HStack >
              <Text size="sm" ml="$8">Subscribe to updates from the Design Feed</Text>
            </HStack>
            <HStack>
              <Checkbox size="lg">
                <Checkbox.Indicator>
            ...
            <HStack>
             <Text size="sm" ml="$8">Subscribe to updates from the Marketing Feed</Text>
            </HStack>
        </VStack>
`,
      transformCode: (code) => {
...
<Checkbox size="lg">
  <Checkbox.Indicator bgColor="$primary600" borderColor="$primary600">
   <Icon as={CheckIcon}  color="$backgroundLight50"/>
  </Checkbox.Indicator>
</Checkbox>
<Checkbox size="lg">
  <Checkbox.Indicator bgColor="$primary600" borderColor="$primary600">
   <Icon as={MinusIcon}  color="$backgroundLight50"/>
  </Checkbox.Indicator>
</Checkbox>
</HStack>
`,
...
<AppProvider>
  <CodePreview
    ...
    metaData={{
      code: `
           <VStack  alignContent='flex-start' space="md">
              <Heading size="sm">Sign up for newsletters</Heading>
              <Checkbox justifyContent="left" size="md">
                  <Checkbox.Indicator>
                    <Checkbox.Icon>
                      <CheckIcon />
                    </Checkbox.Icon>
              ...
              <Text size="sm" color="#737373">Subscibe to newsletters for updates</Text>
           </VStack>
`,
transformCode: (code) => {
return transformedCode(code);
...
<AppProvider>
  <CodePreview
    ...
    metaData={{
      code: `
<VStack space="md">
 <Checkbox justifyContent='right' size="lg">
 <HStack space="lg">
    <Checkbox.Label>Jane Cooper</Checkbox.Label>
     <Checkbox.Indicator>
    <Checkbox.Icon>
      <Icon as={CheckIcon} />
    </Checkbox.Icon>
 ...
 <Checkbox justifyContent='right' defaultIsChecked size="lg">
 <HStack space="lg">
    <Checkbox.Label>Wade Warren </Checkbox.Label>
     <Checkbox.Indicator bgColor="$primary600" >
   <CheckIcon color="$backgroundLight50"/>
  </Checkbox.Indicator>
 ...
 <Checkbox justifyContent='right' size="lg">
 <HStack space="lg">
    <Checkbox.Label>Robert Fox</Checkbox.Label>
   <Checkbox.Indicator>
    <Checkbox.Icon>
      <Icon as={CheckIcon} />
    </Checkbox.Icon>
...
<AppProvider>
 ...
 <Checkbox size="lg">
  ...
  <Checkbox.Label>Hotels,living quarters</Checkbox.Label>
</Checkbox>
`,
      transformCode: (code) => {
        return transformedCode(code);
