      ...
      code: `
           <VStack space="sm">
              ...
              <Checkbox size="md">
                ...
                <Checkbox.Label fontSize="$sm" lineHeight="$md">Daily Bits</Checkbox.Label>
              </Checkbox>
              <Checkbox size="md">
                <Checkbox.Indicator>
                  <Checkbox.Icon as={CheckIcon}/>
               </Checkbox.Indicator>
                 <Checkbox.Label fontSize="$sm" lineHeight="$md">Event Updates</Checkbox.Label>
              </Checkbox>
              <Checkbox size="md">
                <Checkbox.Indicator>
                  <Checkbox.Icon as={CheckIcon}/>
                </Checkbox.Indicator>
                 <Checkbox.Label fontSize="$sm" lineHeight="$md">Sponsorhip</Checkbox.Label>
              </Checkbox>
