...
```jsx
npx install @gluestack-ui add AlertDialog
```
  ...
  <Table>
    ...
    <Table.TBody>
      ...
      <Table.TR>
        ...
        <Table.TD>
          <Text>Callback invoked when the alert-dialog is closed.</Text>
        </Table.TD>
      </Table.TR>
      <Table.TR>
        <Table.TD>
        ...
        <Table.TD>
          <Text>If true, renders react-native native alert-dialog.</Text>
        </Table.TD>
      </Table.TR>
      <Table.TR>
        <Table.TD>
...
import {
  ...
  Body,
  Backdrop,
} from '../ui-components/AlertDialog/styled-components';
...
Default styling of all these components can be found in the `ui-components/AlertDialog` file. For reference, you can view the [source code](https://github.com/gluestack/gluestack-ui/blob/development/example/storybook/src/ui-components/AlertDialog/index.tsx) of the styled `AlertDialog` components.
