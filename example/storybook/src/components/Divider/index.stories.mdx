...
Default styling of the component can be found in the `components/core/divider` file. For reference, you can view the [source code](https://github.com/gluestack/gluestack-ui/blob/development/example/storybook/src/components/Divider/index.tsx) of the styled `Divider` component.
