...
```jsx
// import the styles
import { Root } from '../ui-components/Divider/styled-components';
...
Default styling of the component can be found in the `ui-components/Divider` file. For reference, you can view the [source code](https://github.com/gluestack/gluestack-ui/blob/development/example/storybook/src/ui-components/Divider/index.tsx) of the styled `Divider` component.
