...
```jsx
// import the styles
import { Root, Badge, Group, Image, FallbackText } from './components/Avatar';
...
Default styling of all these components can be found in the `components/Avatar` file. For reference, you can view the [source code](https://github.com/gluestack/universa11y/blob/development/example/storybook/src/components/styled-components/avatar/index.tsx) of the styled `Avatar` components.
