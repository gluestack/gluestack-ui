...
The styles of Gluestack Ui Avatar are injected from [@dank-style/react]('https://www.npmjs.com/package/@dank-style/react') and accessibility and other functionality is provided by [@gluestack-ui/avatar]('https://www.npmjs.com/package/@gluestack-ui/avatar').
