...
import {
  ...
  Image,
  FallbackText,
} from '../ui-components/Avatar/styled-components';
...
Default styling of all these components can be found in the `components/Avatar` file. For reference, you can view the [source code](https://github.com/gluestack/gluestack-ui/blob/development/example/storybook/src/ui-components/Button/index.tsx) of the styled `Avatar` components.
