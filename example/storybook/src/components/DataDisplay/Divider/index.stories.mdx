...
```bash
npx gluestack-ui@latest update divider
```
...
<AppProvider>
  <CodePreview
    ...
    metaData={{
      code: `
        <VStack space='2xl'>
          <HStack px='$3.5' h='$8' rounded='$sm' borderWidth='$1' borderColor='$backgroundLight300' sx={{
            _dark:{
              borderColor: "$backgroundDark700",
            }        
          }}>
          ...
          <HStack px='$3.5' h='$8' rounded='$sm' borderWidth='$1' borderColor='$backgroundLight300' alignItems='center' sx={{
            _dark:{
              borderColor: "$backgroundDark700",
            }        
          }}>
            ...
            <Divider orientation='vertical' h='50%' mx='$3.5'/>
            <Button variant='link' size='xs'>
              <Button.Text >
                Twitter
              </Button.Text>
