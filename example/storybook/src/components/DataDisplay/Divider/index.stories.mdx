...
For customizing the Divider, you have to map styled view to Divider. You can refer [gluestack.io/style](https://style.gluestack.io/styleon on how to use styled components.
