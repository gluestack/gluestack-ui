...
<AppProvider>
  <CodePreview
    ...
    metaData={{
      code: `
        <VStack space='2xl'>
          <HStack h='$8' rounded='$sm' borderWidth='$1' borderColor='$backgroundLight300' sx={{
            _dark:{
              borderColor: "$backgroundDark700",
            }        
          }}>
          ...
          <HStack h='$8' rounded='$sm' borderWidth='$1' borderColor='$backgroundLight300' alignItems='center' sx={{
            _dark:{
              borderColor: "$backgroundDark700",
            }        
          }}>
