...
For customizing the Badge, you have to map styled view to Badge You can refer [gluestack.io/style](/style) for more information on how to use styled components.
