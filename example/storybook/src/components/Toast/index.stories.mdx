...
<AppProvider>
  ...
  return (
    ...
    >
      ...
      scope: { Toast: AccessibleToast, Wrapper, useToast, Pressable, RNText },
      argsType: {},
    }}
  />
</AppProvider>
...
- Toasts can also be configured to pop up at different areas of the application window—top or bottom.
