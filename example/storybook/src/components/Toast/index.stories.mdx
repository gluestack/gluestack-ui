...
import {
  ...
  Title,
  Description,
} from '../ui-components/Toast/styled-components';
...
Default styling of all these components can be found in the `components/Toast` file. For reference, you can view the [source code](https://github.com/gluestack/gluestack-ui/blob/development/example/storybook/src/ui-components/Toast/index.tsx) of the styled `Toast` components.
