...
For customizing the Text, you have to map styled view to Text. You can refer [gluestack.io/style](https://style.gluestack.io/styleon on how to use styled components.
