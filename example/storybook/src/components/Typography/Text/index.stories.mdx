...
For customizing the Text, you have to map styled view to Text. You can refer [gluestack.io/style](/style) for more information on how to use styled components.
