...
```jsx
// import the styles
import { Root } from '../ui-components/Pressable/styled-components';
...
Default styling of the component can be found in the `ui-components/Pressable` file. For reference, you can view the [source code](https://github.com/gluestack/gluestack-ui/blob/development/example/storybook/src/ui-components/Pressable/index.tsx) of the styled `Pressable` component.
