...
```jsx
// import the styles
import { Root } from './components/Pressable';
...
Default styling of the component can be found in the `components/Pressable` file. For reference, you can view the [source code](https://github.com/gluestack/universa11y/blob/development/example/storybook/src/components/styled-components/pressable/index.tsx) of the styled `Pressable` component.
