...
```jsx
// import the styles
import { Root } from '../components/core/core/box/styled-components';
...
Default styling of the component can be found in the `components/core/box` file. For reference, you can view the [source code](https://github.com/gluestack/gluestack-ui/blob/development/example/storybook/src/components/Box/index.tsx) of the styled `Box` component.
