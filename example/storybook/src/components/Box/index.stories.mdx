...
```jsx
// import the styles
import { Root } from '../ui-components/Box/styled-components';
...
Default styling of the component can be found in the `ui-components/Box` file. For reference, you can view the [source code](https://github.com/gluestack/gluestack-ui/blob/development/example/storybook/src/ui-components/Box/index.tsx) of the styled `Box` component.
