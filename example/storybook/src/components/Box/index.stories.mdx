...
For customozing the Box, you have to map styled view to Box. You can refer [dank.style](https://dank.style/) for more information on how to use styled components.

### Usage

```jsx
// import the styles
import { Root } from './components/Box';
...
Default styling of the component can be found in the `components/Box` file. For reference, you can view the [source code](https://github.com/gluestack/universa11y/blob/development/example/storybook/src/components/styled-components/box/index.tsx) of the styled `Box` component.
