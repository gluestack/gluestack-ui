  ...
  <Table>
    ...
    <Table.TBody>
      ...
      <Table.TR>
        ...
        <Table.TD>
          <Text>Function called when the state of the radio changes.</Text>
        </Table.TD>
      </Table.TR>
      <Table.TR>
        <Table.TD>
        ...
        <Table.TD>
          <Text>If Table.TRue, the radio will be initially checked.</Text>
        </Table.TD>
      </Table.TR>
      <Table.TR>
        <Table.TD>
      ...
      <Table.TR>
        ...
        <Table.TD>
          <Text>To manually set disable to the radio.</Text>
        </Table.TD>
      </Table.TR>
      <Table.TR>
        <Table.TD>
        ...
        <Table.TD>
          <Text>To manually set invalid to the radio.</Text>
        </Table.TD>
      </Table.TR>
      <Table.TR>
        <Table.TD>
        ...
        <Table.TD>
          <Text>To manually set readonly to the radio.</Text>
        </Table.TD>
      </Table.TR>
      <Table.TR>
        <Table.TD>
        ...
        <Table.TD>
          <Text>To manually set hover to the radio.</Text>
        </Table.TD>
      </Table.TR>
      <Table.TR>
        <Table.TD>
        ...
        <Table.TD>
          <Text>To manually set focus visible state to the radio. radio.</Text>
        </Table.TD>
      </Table.TR>
      <Table.TR>
        <Table.TD>
        ...
        <Table.TD>
          <Text>To manually set indeterminate to the radio.</Text>
        </Table.TD>
      </Table.TR>
    </Table.TBody>
  </Table>
  ...
  <Table>
    ...
    <Table.TBody>
      <Table.TR>
        ...
        <Table.TD>
          <Text>The value of the radio group.</Text>
        </Table.TD>
      </Table.TR>
      <Table.TR>
        <Table.TD>
...
```jsx
// import the styles
import { Root, Indicator, Icon, Label, Group } from './components/radio';
...
Default styling of all these components can be found in the `components/Radio` file. For reference, you can view the [source code](https://github.com/gluestack/universa11y/blob/development/example/storybook/src/components/styled-components/radio/index.tsx) of the styled `Radio` components.
