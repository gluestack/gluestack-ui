...
```jsx
// import the styles
import { Root } from './components/Spinner';
...
Default styling of all these components can be found in the `components/Spinner` file. For reference, you can view the [source code](https://github.com/gluestack/universa11y/blob/development/example/storybook/src/components/styled-components/spinner/index.tsx) of the styled `Spinner` components.
