...
For customizing the Box, you have to map styled view to Box. You can refer [style.gluestack.io](https://style.gluestack.io/docs/getting-started/styled) for more information on how to use styled components.
