...
For customizing the Center, you have to map styled view to Center. You can refer [gluestack.io/style](https://style.gluestack.io/styleon on how to use styled components.
