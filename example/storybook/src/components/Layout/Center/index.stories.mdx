...
For customizing the Center, you have to map styled view to Center. You can refer [style.gluestack.io](https://style.gluestack.io/) for more information on how to use styled components.
