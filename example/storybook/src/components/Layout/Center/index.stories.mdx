...
pageDescription: Center aligns its contents to the center within itself. It is a layout component.
...
It inherits all the properties of React Native's [Center](https://reactnative.dev/docs/view#props) component.
