...
For customizing the Center, you have to map styled view to Center. You can refer [gluestack.io/style](/style) for more information on how to use styled components.
