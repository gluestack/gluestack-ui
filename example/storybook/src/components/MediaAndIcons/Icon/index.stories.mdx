...
```jsx
npx gluestack-ui@latest add icon
```
...
<HStack w="70%" flexWrap= 'wrap'>
  <Icon as={AddIcon} m="$2" />
  <Icon as={HamburgerIcon} m="$2" />
  <Icon as={ArrowBackIcon} m="$2" />
  <Icon as={ArrowDownIcon} m="$2" />
  <Icon as={ArrowForwardIcon} m="$2" />
  <Icon as={ArrowUpIcon} m="$2" />
  <Icon as={ChevronDownIcon} m="$2" />
  <Icon as={ChevronUpIcon} m="$2" />
  <Icon as={ChevronLeftIcon} m="$2" />
  <Icon as={ChevronRightIcon} m="$2" />
  <Icon as={CheckIcon} m="$2" />
  <Icon as={CircleIcon} m="$2" />
  <Icon as={CloseIcon} m="$2" />
  <Icon as={InfoIcon} m="$2" />
  <Icon as={WeatherMoon}m="$2" />
  <Icon as={MinusIcon} m="$2" />
  <Icon as={MoonIcon} m="$2" />
  <Icon as={QuestionIcon} m="$2" />
  <Icon as={SearchIcon} m="$2" />
  <Icon as={SunIcon} m="$2" />
  <Icon as={WarningIcon} m="$2" />
  <Icon as={WarningOutlineIcon} m="$2" />
  <Icon as={ThreeDotsIcon} m="$2" />
  <Icon as={PlayIcon} m="$2" />
  <Icon as={ShareIcon} m="$2" />
  <Icon as={FavouriteIcon} m="$2" />
  <Icon as={DeleteIcon}m="$2" />
  <Icon as={CloseIconFilled} m="$2" />
</HStack>
`,
      transformCode: (code) => {
        return transformedCode(code);
