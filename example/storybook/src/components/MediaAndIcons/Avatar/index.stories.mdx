  ...
  <CodePreview
    ...
    <VStack space="2xl">
        <HStack space="md">
          ...
          <VStack>
             <Heading size="sm" lineHeight="$md" color="$textLight900">Ronald Richards</Heading>
             <Text fontSize="$sm" lineHeight="$md" color="$textLight900">Nursing Assistant</Text>
          </VStack>
      </HStack>
      <HStack space="md">
        ...
        <VStack>
            <Heading size="sm" lineHeight="$md" color="$textLight900">Arlene McCoy</Heading>
            <Text fontSize="$sm" lineHeight="$md" color="$textLight900">Marketing Coordinator</Text>
        </VStack>
     </HStack>
    </VStack>
`,
  ...
  <CodePreview
    ...
    metaData={{
      ...
      <HStack space="md">
        ...
        <VStack >
          <Heading size="sm" lineHeight="$md" color="$textLight900">Kevin James</Heading>
          <Text fontSize="$sm" lineHeight="$md" color="$textLight900">Hi Rachel, What's up?</Text>
        </VStack>
      </HStack>
`,
      transformCode: (code) => {
      ...
      code: `
        <VStack space="2xl">
            <HStack space="sm">
              ...
              <VStack ml="$2.5">
                <Heading size="sm" lineHeight="$md" color="$textLight900">Ronald Richards</Heading>
                <Text size="sm" lineHeight="$md" color="$textLight900">Nursing Assistant</Text>
              </VStack>
            </HStack>
            <HStack space="sm">
                ...
                <VStack ml="$2.5">
                  <Heading size="sm" lineHeight="$md" color="$textLight900">Kevin James</Heading>
                  <Text size="sm" lineHeight="$md" color="$textLight900">Web Designer</Text>
                </VStack>
          </HStack>
        </VStack>
      `,
      ...
      code: `
        <VStack space="2xl">
          ...
          <HStack space="sm">
            ...
            <VStack ml="$2.5">
              <Heading size="sm" lineHeight="$md" color="$textLight900">Arlene McCoy</Heading>
              <Text size="sm" lineHeight="$md" color="$textLight900">Marketing Coordinator</Text>
            </VStack>
          </HStack>
        </VStack>
      `,
      ...
      code: `
        function App(){
          const avatars = [
              ...
              { src: 'https://example.com.jpg', alt: 'Rahul Sharma ', color:'$gray600' },
          ];
          ...
          return (
            <Avatar.Group >
              {avatars.slice(0, 3).map((avatar, index) => {
                return (
                  <Avatar key={index} size="lg" borderColor="$white" borderWidth="$2" bgColor={avatar.color}>
                    <Avatar.FallbackText>{avatar.alt}</Avatar.FallbackText>
                  </Avatar>
                );
              })}
              <Avatar size="lg" color="$white" borderColor="$white" borderWidth="$2"  >+{remainingCount}</Avatar>
            </Avatar.Group>
          );
        }
      `,
