  ...
  <CodePreview
    ...
    metaData={{
      code: `
       function App(){
        const avatars = [
            { src: 'https://example.com.jpg', alt: '1S' , color:'$emerald600' },
            { src: 'https://example.com.jpg', alt: '2K' , color:'$cyan600' },
            { src: 'https://example.com.jpg', alt: '3S', color:'$indigo600' },
            { src: 'https://example.com.jpg', alt: '4K', color:'$gray600' },
            { src: 'https://example.com.jpg', alt: '5E', color:'$gray600' },
        ];
      ...
      return (
        <Avatar.Group >
          ...
          <Avatar size="lg">{remainingCount}</Avatar>
        </Avatar.Group>
      )
    }  
`,
