...
import { Avatar, HStack, VStack, AvatarIcon, Icon, Heading } from './Avatar';
...
<AppProvider>
  <CodePreview
    ...
    metaData={{
      ...
      <VStack space="md">
 <HStack>
 <Avatar size="md" bgColor="#A5B4FC" borderColor="#4F46E5" borderWidth={2}>
 <AvatarIcon color="#4F46E5"/>        
 </Avatar>
        <VStack  ml="10px" >
          <Heading size="sm">Ronald Richards</Heading>
          <Text size="sm">Nursing Assistant</Text>
      ...
      <HStack>
 <Avatar size="md" backgroundColor="#F9A8D4" bgColor="#A5B4FC" borderColor="#DB2777" borderWidth={2}>
           <AvatarIcon color="#DB2777"/>  
         </Avatar>
        <VStack  ml="10px" >
          <Heading size="sm">Kevin James</Heading>
          <Text size="sm">Web Designer</Text>
