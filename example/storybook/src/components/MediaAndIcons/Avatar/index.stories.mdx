...
description: The Avatar component can display profile pictures, initials, or a fallback icon to represent a user.
pageTitle: Avatar
pageDescription: The Avatar component can display profile pictures, initials, or a fallback icon to represent a user.
showHeader: true
---
