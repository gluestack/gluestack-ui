...
For customizing the Image, you have to map styled Image to Image. You can refer [gluestack.io/style](https://style.gluestack.io/styleon on how to use styled components.
