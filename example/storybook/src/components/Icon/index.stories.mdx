...
```jsx
// import the styles
import { Root } from '../ui-components/Icon/styled-components';
...
Default styling of all these components can be found in the `ui-components/Icon` file. For reference, you can view the [source code](https://github.com/gluestack/gluestack-ui/blob/development/example/storybook/src/ui-components/Icon/index.tsx) of the styled `Icon` components.
