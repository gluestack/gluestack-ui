...
```jsx
// import the styles
import { Root, Spacer } from '../ui-components/HStack/styled-components';
...
Default styling of the component can be found in the `ui-components/HStack` file. For reference, you can view the [source code](https://github.com/gluestack/gluestack-ui/blob/development/example/storybook/src/ui-components/HStack/index.tsx) of the styled `HStack` component.
