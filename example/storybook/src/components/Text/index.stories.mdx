...
```jsx
// import the styles
import { Root } from '../ui-components/Text/styled-components';
...
Default styling of the component can be found in the `ui-components/Text` file. For reference, you can view the [source code](https://github.com/gluestack/gluestack-ui/blob/development/example/storybook/src/ui-components/Text/index.tsx) of the styled `Text` component.
