...
For customizing the Progress, you have to map styled view to Progress You can refer [gluestack.io/style](https://gluestack.io/style) for more information on how to use styled components.

#### Usage

Default styling of the component can be found in the `components/core/progress` file. For reference, you can view the [source code](https://github.com/gluestack/gluestack-ui/blob/main/packages/themed/src/components/Progress/index.tsx) of the styled `Progress` component.
