...
For customizing the Progress, you have to map styled view to Progress You can refer [gluestack.io/style](https://style.gluestack.io/styleon on how to use styled components.
