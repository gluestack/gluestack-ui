...
<AppProvider>
  <CodePreview
    ...
    metaData={{
      code: `
        <Alert mx='$2.5' {...props} bg='#BBF7D0' borderColor='#15803D'>
          <Alert.Icon h='$6' w='$6' position='relative' bottom='$6'>
            <Icon as={CheckCircleIcon} h='$5' w='$5'/>
          </Alert.Icon>
          <VStack maxWidth='90%' space='xs'>
            <Alert.Text fontWeight ='$medium' fontSize='$md'>
...
<AppProvider>
  <CodePreview
    ...
    metaData={{
      code: `
        <Alert action='success' mx='$2.5' bg='#BBF7D0' borderColor='#15803D' show={false}>
          <Alert.Icon h='$5' w='$5' position='relative' bottom='$6'>
            <Icon as={CheckCircleIcon} h='$5' w='$5'/>
          </Alert.Icon>
          <VStack maxWidth='90%' space='xs'>
