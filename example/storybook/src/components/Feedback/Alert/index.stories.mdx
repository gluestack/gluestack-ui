...
import { BellIcon, AlertCircleIcon, Center, VStack } from './Alert';
...
<AppProvider>
  <CodePreview
    ...
    metaData={{
      code: `
        <Alert mx='$2.5'  {...props}>
          <Alert.Icon as={InfoIcon} mr="$3" minWidth={18} />
          <Alert.Text>
    ...
    metaData={{
      code: `
        <VStack space="md" w="80%" justifyContent="center" alignItems="center" px="$4">
          <Alert action="info">
            <Alert.Icon minWidth={18} as={InfoIcon}  mr="$3"/>
            <Alert.Text>
          ...
          <Alert action="success">
            <Alert.Icon minWidth={18} as={CheckCircleIcon} mr="$3" />
            <Alert.Text>
          ...
          <Alert action="error">
            <Alert.Icon minWidth={18} as={CloseCircleIcon} mr="$3"/>
            <Alert.Text>
          ...
          <Alert action="warning">
            <Alert.Icon minWidth={18} as={AlertCircleIcon} mr="$3" />
            <Alert.Text>
          ...
          <Alert action="muted">
            <Alert.Icon minWidth={18} as={BellIcon} mr="$3" />
            <Alert.Text>
    ...
    metaData={{
      code: `
        <Alert action='success' mx='$2.5' bg='$success100' borderColor='$success700'>
          <Alert.Icon as={CheckCircleIcon} minHeight='$6' minWidth='$6'  mr="$3" />
