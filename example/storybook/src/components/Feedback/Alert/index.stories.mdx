    ...
    metaData={{
      code: `
        <VStack space="md" w="80%" justifyContent="center" alignItems="center" px="$4">
          <Alert action="info">
            <Alert.Icon minWidth={18} as={InfoIcon} />
            <Alert.Text>
          ...
          <Alert action="success">
            <Alert.Icon minWidth={18} as={CheckCircleIcon} />
            <Alert.Text>
          ...
          <Alert action="error">
            <Alert.Icon minWidth={18} as={CloseIconFilled}/>
            <Alert.Text>
          ...
          <Alert action="warning">
            <Alert.Icon minWidth={18} as={WarningIcon} />
            <Alert.Text>
          ...
          <Alert action="muted">
            <Alert.Icon minWidth={18} as={NotificationIcon} />
            <Alert.Text>
...
Default styling of all these components can be found in the `components/core/alert` file. For reference, you can view the [source code](https://github.com/gluestack/gluestack-ui/tree/patch/example/storybook/src/ui-components/Alert) of the styled `Alert` components.
