...
import { CheckIcon, ChatIcon, DangerIcon } from './Toast';
      ...
      code: `
        function Example() {
          ...
          const placements = {
            ...
            'top-right': 'You are hiding in plain sight at the top right corner! You are good at this game.',
            'top-left': 'You are a master of disguise hiding in the top left corner! Keep up the sneakiness.',
            'bottom-left': 'You are not the best at hiding, but we found you in the bottom left corner.',
            'bottom-right': 'Found you! Dont worry, we wont tell anyone.',
          }
          const {...props}
          return (
            <Pressable
                  ...
                  render: ({ id }) => {
                    return (
                      <Toast bg='$secondary700' nativeId={id} p='$3'>
                        <Icon as={ChatIcon} color='$white' mt='$1' mr='$3' />
                        <VStack space='xs'>
                  ...
                  render: ({ id }) => {
                    return (
                      <Toast bg='$error700' nativeId={id} p='$3'>
                        <Icon as={DangerIcon} color='$black' mt='$1' mr='$3' />
                        <VStack space='xs'>
