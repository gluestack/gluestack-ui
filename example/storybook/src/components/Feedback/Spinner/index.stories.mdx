...
We have a function called `createSpinner` which can be used to create a custom `Spinner` component. This function takes in a configuration object which contains the styled components that you want to use for the spinner. You can refer [gluestack.io/style](/style) for more information on how to use styled components.
