...
```jsx
// import the styles
import { Root, FilledTrack } from '../ui-components/Progress/styled-components';
...
Default styling of the component can be found in the `ui-components/Progress` file. For reference, you can view the [source code](https://github.com/gluestack/gluestack-ui/blob/development/example/storybook/src/ui-components/Progress/index.tsx) of the styled `Progress` component.
