  ...
  <Table>
    ...
    <Table.TBody>
      ...
      <Table.TR>
        ...
        <Table.TD>
          <Text>If true, the checkbox will be initially checked.</Text>
        </Table.TD>
      </Table.TR>
      <Table.TR>
        <Table.TD>
        ...
        <Table.TD>
          <Text>
            When true, its checkbox is checked. the checkbox will be checked.
      ...
      <Table.TR>
        ...
        <Table.TD>
          <Text>To manually set focus visible state to the checkbox</Text>
        </Table.TD>
      </Table.TR>
      <Table.TR>
        <Table.TD>
