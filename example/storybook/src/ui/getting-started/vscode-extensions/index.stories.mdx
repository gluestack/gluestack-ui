...
<Meta title="ui/Introduction/Getting Started/VS Code Extensions" />

# VS Code Extensions

[gluestack VS Code Extension](https://marketplace.visualstudio.com/items?itemName=gluestack.gluestack-vscode) is specially crafted to streamline your development process when using the `@gluestack-ui/themed` library. It provides a set of powerful features to accelerate your workflow and improve efficiency.
