...
<Meta title="ui/Configuration/Theme Configuration/Theme/Default Tokens" />
...
The space key allows you to customize the global spacing and sizing scale for your project. By default these spacing value can be referenced by the padding, margin, and top, left, right, bottom, props. You can refer to [this](style/docs/configuration/theme-tokens) to see the aliases for the spacing props.
