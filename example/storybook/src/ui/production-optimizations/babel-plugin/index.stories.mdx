...
import { AppProvider, Box } from '@gluestack-ui/design-system';

<Meta title="ui/Production Optimizations/With a Babel Plugin" />
...
3. Add `GLUESTACK_STYLE_TARGET` environment variable, 'native' or 'web' depending on platform to remove unwanted props and data
