...
import ThemeConfigurator from '../../../../../../../docs-components/nativewind/extra-components/nativewind/token-configurator/TokenConfigComponent';

import ThemeConfiguratorComponent from './ThemeConfig';
