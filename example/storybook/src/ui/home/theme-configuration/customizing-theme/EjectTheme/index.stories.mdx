...
You can customize all the tokens of the theme in `config`. For a complete list of tokens and default values, please check [default Tokens](https://v1.gluestack.io/ui/docs/theme-configuration/theme/default-tokens).
