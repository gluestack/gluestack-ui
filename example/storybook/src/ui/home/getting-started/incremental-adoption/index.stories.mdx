...
- Install `@gluestack-ui/themed`
  - Follow [these](https://v1.gluestack.io/ui/docs/guides/install-expo) steps if you are using Expo
  - Follow [these](https://v1.gluestack.io/ui/docs/guides/install-rn) steps if you are using React Native Bare App.
...
To customize your theme, please follow the steps mentioned in the [docs](https://v1.gluestack.io/ui/docs/theme-configuration/customizing-theme/eject-library).
