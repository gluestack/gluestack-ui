...
We can define styles that can be applied on different states and pass them as an object in `sx` prop. For more details, checkout [State Based Styles](https://v1.gluestack.io/style/docs/api/state-bases-styles) documentation.
