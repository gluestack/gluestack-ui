...
- **Animation**: gluestack-ui provides a plugin to add support for Animation using Animation libraries like [@legendapp/motion](https://legendapp.com/open-source/motion/) and [moti](https://moti.fyi/). [Check here](https://v1.gluestack.io/style/docs).
