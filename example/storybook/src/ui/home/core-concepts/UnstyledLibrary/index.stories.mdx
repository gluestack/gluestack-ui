...
<Meta title="ui/Home/Core Concepts/Unstyled Library" />
...
But, it also comes with a package called `@gluestack-ui/config`, which has ready-made styles for all the components. So, you can choose these styles if you like. Please visit [Themed Library](https://v1.gluestack.io/ui/docs/core-concepts/themed-library) for more information.

And, the cool part is, you can even create your own unique style if you want to give these components a personal touch.

> Note: If you want to create your own design system with these components, it's advisable to refer to the customization guide available [guide](https://v1.gluestack.io/ui/docs/guides/building-design-systems).
