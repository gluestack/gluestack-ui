...
<Meta title="ui/Home/Core Concepts/Themed Library" />
...
`@gluestack-ui/config` exports a config file that allows us to manipulate the theme tokens and add new themes. Theme tokens are standardized values that represent various design attributes, such as colors, typography settings, spacing, and more. These tokens serve as a consistent and centralized way to define and manage the visual properties of UI components across your application. Customizing these tokens can also be done, for more information refer to this [link](https://v1.gluestack.io/ui/docs/theme-configuration/customizing-theme/eject-library).

Component styling is accomplished through [`@gluestack-style/react`](https://v1.gluestack.io/style). You can customize the styles of each component, and detailed information related to that is available [here](https://v1.gluestack.io/ui/docs/theme-configuration/customizing-theme/eject-library).
