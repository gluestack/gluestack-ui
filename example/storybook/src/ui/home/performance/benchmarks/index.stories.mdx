...
`gluestack-ui` harnesses the power of [`gluestack-style`](https://v1.gluestack.io/style), a universal and highly performant styling library, to create beautifully styled components. **With a babel plugin for pre-computing styles during the build process, and runtime performance optimizations, gluestack-style delivers high performance styling, even in the most demanding applications.**
