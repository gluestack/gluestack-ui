...
<Meta title="ui/components/Disclosure/Tabs" />
    ...
    <Table>
      ...
      <Table.TBody>
        <Table.TR>
          ...
          <Table.TD>
            <Table.TText>{`The value of the tab that should be active when initially rendered.`}</Table.TText>
          </Table.TD>
        </Table.TR>
        <Table.TR>
          <Table.TD>
          ...
          <Table.TD>
            <Table.TText>{`Use when you do not need to control the state of the tabs.`}</Table.TText>
          </Table.TD>
        </Table.TR>
        <Table.TR>
          <Table.TD>
...
Contains the tabs that are aligned along the edge of the active content.
...
The button that activates its associated content. Must be wrapped with `TabList`.
...
- `ArrowDown` - Moves focus to the next trigger and activates its associated content.
- `ArrowUp` - Moves focus to the previous trigger and activates its associated content.
