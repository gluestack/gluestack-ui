...
<Meta title="ui/components/Disclosure/Accordion" />
              ...
              {({ isExpanded }) => {
                return (
                  <>
                    ...
                    {isExpanded ? (
                      <AccordionIcon key="chevron-up-icon" as={ChevronUpIcon} ml="$3"/>
                    ) : (
                      <AccordionIcon key="chevron-down-icon" as={ChevronDownIcon} ml="$3"/>
                    )}
                  </>
                );
              }}
            ...
            {({ isExpanded }) => {
              return (
                <>
                  ...
                  {isExpanded ? (
                    <AccordionIcon key="chevron-up-icon" as={ChevronUpIcon} />
                  ) : (
                    <AccordionIcon key="chevron-down-icon" as={ChevronDownIcon} />
                  )}
                </>
              );
            }}
...
function App(){
    return (
          <Accordion size="md" shadowColor="transparent" m="$5" width="80%" maxWidth={640}>
...
function App(){
    return (
          <Accordion size="md" shadowColor="transparent" m="$5" variant="unfilled" width="80%" maxWidth={640}>
...
function App(){
    return (
          <Accordion size="md" shadowColor="transparent" m="$5" variant="unfilled" type="single" defaultValue="item-3" width="80%" maxWidth={640}>
      <AccordionItem value="item-1" borderRadius="$lg">
        <AccordionHeader>
          <AccordionTrigger px="$0">
            {({ isExpanded }) => {
      ...
      <AccordionItem value="a">
        ...
        <AccordionContent pb="$0">
          <Accordion
            ...
            backgroundColor="$backgroundLight50"
            $dark-borderColor="$borderDark700"
            $dark-backgroundColor="$backgroundDark70"
          >
            <AccordionItem value="b">
              <AccordionHeader>
                <AccordionTrigger>
