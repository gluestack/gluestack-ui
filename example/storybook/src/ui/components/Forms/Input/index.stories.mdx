    ...
    metaData={{
      code: `
        function App() {
          ...
          const handleLogin = () => {
            setShowModal(true); // Show the modal on login button click
          };
            ...
            <>
                ...
                <ModalContent>
                  ...
                  <ModalBody>
                    <Text size="sm" className="text-typography-500">
                      You are now logged in. Explore the app and start collaborating with your team.
                    </Text>
                  </ModalBody>
                  <ModalFooter>
                    <Button
              ...
              >
                <VStack space='xl'>
                  ...
                  <Button
                    ml='auto'
                    onPress={handleLogin} // Trigger the modal on login button press
                  >
