...
<Meta title="ui/Theme Configuration/Customizing Theme" />
...
Customizing components allows you to tailor the components according to you design system or guidelines to match your project's unique visual identity. To customize tokens, follow these steps:
