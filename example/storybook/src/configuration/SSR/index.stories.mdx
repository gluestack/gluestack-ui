---
title: Server-Side Rendering | gluestack-css
description: gluestack-css provides support for server-side rendering (SSR) by exporting a flush function to flush out any styles that were generated during the SSR process.
---
