---
title: Animation Plugin | gluestack-css
description: Learn to add animation props with gluestack-css’s Animation Plugin for dynamic, animated UI elements. Performance impacts and lack of typings are limitations.
...
gluestack-css offers a plugin that supports animation properties, utilizing animation libraries such as [@legendapp/motion](https://legendapp.com/open-source/motion/), [framer-motion](https://www.framer.com/motion/), and [moti](https://moti.fyi/). We will use `@legendapp/motion` in this example.
