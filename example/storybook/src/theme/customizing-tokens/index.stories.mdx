...
but for recipe we will update primary color token of the theme. In order to change the primary color of the theme, you need to update the token of `colors` primary. we can do that using createConfig as demonstrated below.
