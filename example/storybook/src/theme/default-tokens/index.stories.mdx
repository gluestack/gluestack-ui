...
pageDescription: gluestack-ui ships with default tokens that provide access to theme values and lets you build and customize your own themed components.
showHeader: true
---
...
It has Colors, Aliases, Typography, Size, Opacity, Shadows, Breakpoint. Theming in `@gluestack-ui/themed` is based on the [Styled System Theme Specification](https://github.com/system-ui/theme-specification).
