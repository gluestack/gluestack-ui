---
title: Platform Based Styles | gluestack-css
description: Writing platform based styles in gluestack-css. This allows you to easily create styles that are specific to a particular platform that is, Web, iOS, or Android.
---
