---
title: Responsive Styles | gluestack-css
description: gluestack-css supports responsive styles using media queries. You can define your breakpoints and other configuration options.
...
gluestack-css supports responsive styles using media queries.
