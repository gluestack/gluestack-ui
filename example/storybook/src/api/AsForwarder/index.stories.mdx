---
title: AsForwarder | gluestack-css
description: gluestack-css Style exports a AsForwarder component that can be used to configure the library.
---
...
gluestack-css Style provides an 'as' prop for library configuration.
