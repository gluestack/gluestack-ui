...
2. **ancestorStyle** is an array of string that denotes the ancestors of that component. This is useful for o “creating complex styles that are dependent on the ancestor component.
