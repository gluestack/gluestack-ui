...
`mediaQueries` is an object that lets you define a custom media queries(breakpoints) for your app. To configure mediaQueries in `@gluestack-style/react`, you can create a `dank.config.js` file where you define your mediaQueries and other configuration options.
