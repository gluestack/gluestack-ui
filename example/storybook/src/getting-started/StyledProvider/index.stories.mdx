---
title: StyledProvider | gluestack-css
description: gluestack-css Style exports a StyledProvider component, a higher-order component that wraps your entire application and provides the library's configuration options.
---
...
**`gluestack-css`** exports a **`StyledProvider`** component that can be used to configure the library.
