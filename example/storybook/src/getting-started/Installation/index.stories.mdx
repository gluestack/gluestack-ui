...
```bash
Init gluestack-ui: npx gluestack-ui init

Init and add components: npx gluestack-ui

Add component: npx gluestack-ui add <component-name>

Update component: npx gluestack-ui update <component-name>

Remove component: npx gluestack-ui remove <component-name>

Help: npx gluestack-ui help
