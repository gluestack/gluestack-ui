...
gluestack-css provides support for [Expo](https://expo.dev/) and [Next.js](https://nextjs.org/) both.

Refer the guides shown below to setup gluestack-css in your Expo or Next.js app.
...
Throughout this guide, we have provided detailed instructions on how to install `gluestack-css` in your Expo or Next.js application and configure its settings to ensure optimal performance. We highly recommend taking the time to familiarize yourself with the various aspects of gluestack-css, such as its configuration options and styled provider functionality, as well as the styled function.
