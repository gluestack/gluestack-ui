...
It's also recommended to set up your server-side rendering (SSR) correctly. To do this, you will need to use the `flush()` function exported by the [@glue-style/react](https://dank.style/docs/configuration/ssr) and call it in your `_document.tsx` file.
