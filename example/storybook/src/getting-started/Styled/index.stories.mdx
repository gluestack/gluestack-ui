---
title: styled - Extend existing components | gluestack-css
description: With styled, you can easily extend existing components and make them customizable and themeable. gluestack-css has provided styled function for this.
---
