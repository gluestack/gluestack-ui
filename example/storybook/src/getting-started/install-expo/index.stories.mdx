...
```bash
yarn add @gluestack-style/react @gluestack-style/animation-plugin @gluestack-ui/react

npm i @gluestack-style/react @gluestack-style/animation-plugin @gluestack-ui/react
```
