...
After installing gluestack-css, you need to set up the `config` and `StyledProvider` at the root of your application. This can be either in your `App.tsx` or `App.jsx`.
