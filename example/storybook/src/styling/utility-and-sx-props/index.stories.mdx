...
React Native has a great StyleSheet API which is optimal for component-based systems. [@gluestack-style/react](https://style.gluestack.io/styledds a layer of utility props and constraint based designed tokens on top of it. `@gluestack-style/react` is used as styling engine for `@gluestack-ui/themed`.
