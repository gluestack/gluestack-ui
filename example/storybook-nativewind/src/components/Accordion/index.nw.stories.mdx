---
title: Accordion UI | gluestack-ui | Installation, Usage & API

description: Explore gluestack's Accordion UI component for React & React Native. Build sleek, interactive accordions with ease. Learn more about Accordion UI now!

pageTitle: Accordion

pageDescription: Explore gluestack's Accordion UI component for React & React Native. Build sleek, interactive accordions with ease. Learn more about Accordion UI now!
