...
It inherits all the properties of of @expo/html-elements's [TD](https://www.npmjs.com/package/@expo/html-elements#td) on native and html td tag on web.

#### TableHead 

It inherits all the properties of of @expo/html-elements's [TH](https://www.npmjs.com/package/@expo/html-elements#th) on native and html th tag on web.
