                ...
                toast.show({
                  ...
                  render: ({ id }) => {
                    ...
                    return (
                      <Toast
                        nativeID={toastId}
                        className="p-4 gap-4 w-full bg-background-900 shadow-hard-5 max-w-[404px]"
                      >
                        <HStack space="md">
                          <Icon as={CheckCircleIcon} className="stroke-background-0" />
                          <VStack>
                            <ToastTitle className="text-typography-0 font-semibold">
                              Note Updated
                            </ToastTitle>
                            <ToastDescription className="text-typography-100" size="sm">
                              “SaaS Revenue” has been updated successfully
                            </ToastDescription>
                          </VStack>
                        </HStack>
                        <Pressable onPress={() => toast.close(id)}>
                ...
                toast.show({
                  ...
                  render: ({ id }) => {
                    ...
                    return (
                      <Toast
                        nativeID={toastId}
                        className="p-4 gap-3 w-full sm:min-w-[386px] bg-background-0 shadow-hard-2 flex-col"
                      >
                ...
                toast.show({
                  ...
                  render: ({ id }) => {
                    ...
                    return (
                      <Toast
                        nativeID={toastId}
                        className="p-4 gap-4 w-full max-w-[386px] bg-background-0 shadow-hard-2"
                      >
                        <Box className="h-11 w-11 items-center justify-center hidden min-[400px]:flex">
                ...
                toast.show({
                  ...
                  render: ({ id }) => {
                    ...
                    return (
                      <Toast
                        nativeID={toastId}
                        className="px-5 py-3 gap-4 shadow-soft-1 items-center"
                      >
