...
<Meta title="with-gluestack-style/components/Typography/Text" />
...
This is an illustration of a **Text** component with default configuration.
...
```jsx
%%-- File: components-example/themed/Text/index.tsx --%%
```
