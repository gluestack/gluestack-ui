...
<Meta title="common/components/Button" />
...
This is an illustration of a **NativeWind Button** component with default configuration.
...
```jsx
%%-- File: components-example/nativewind/Button/index.tsx --%%
```
