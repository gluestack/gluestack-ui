...
<Wrapper>
  <CodePreview
   ...
   _rendererWrapper={{
    ...
    metaData={{
      code: `
      <Box className="w-[325px] gap-4 p-3 rounded-md bg-neutral-50">
    ...
    <Table>
      ...
      <Table.TBody>
        ...
        <Table.TR>
          ...
          <Table.TD>
            <Table.TText>bg-neutral-200</Table.TText>
          </Table.TD>
          <Table.TD>
...
<Wrapper>
  <CodePreview
    ...
    metaData={{
      code: `
      <Box className="w-[300px] h-[200px] p-3 rounded-sm bg-neutral-50 ">
