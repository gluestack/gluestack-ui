...
import {Tabs, CollapsibleCode, Table, InlineCode, TableContainer} from '@gluestack/design-system';
...
<Wrapper>
  <CodePreview
   ...
   _rendererWrapper={{
    ...
    metaData={{
      code: `
      <Box className="min-w-[225px] max-w-[325px] gap-4 p-3 rounded-md bg-background-100">
...
<Wrapper>
  <CodePreview
    ...
    metaData={{
      code: `
       <Box className="min-w-[205px] max-w-[290px] h-[400px] p-4 rounded-sm bg-background-100 gap-3">
        <Skeleton variant="rounded" className="h-44 min-w-44 max-w-64 rounded-sm" {...props}>
          <Image
