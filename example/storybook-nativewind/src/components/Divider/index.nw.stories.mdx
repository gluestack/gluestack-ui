        ...
        >
          ...
          >
            ...
            <Divider
              ...
              className="mx-2.5 bg-emerald-500 h-[15px]"
            />
            <Text>Easy</Text>
            <Divider
              orientation="vertical"
              className="mx-2.5 bg-indigo-500 h-[15px]"
            />
            <Text>Beautiful</Text>
          </HStack>
          <VStack
  ...
  <CodePreview
    ...
    metaData={{
      code: `
        <VStack space='2xl'>
          <HStack 
          className="px-3 h-8 rounded border border-outline-300"
          >
          ...
          <HStack 
          className="px-3 h-8 rounded border border-outline-300 items-center"
          >
            <Button variant='link' size='xs'>
              <ButtonText >
                Github
            ...
            <Divider orientation='vertical' className="h-[50%]
            mx-2.5"/>
            <Button variant='link' size='xs'>
              <ButtonText >
                Discord
