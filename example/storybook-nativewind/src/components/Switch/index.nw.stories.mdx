...
import { VStack, Text } from '../../components-example/nativewind';
import { HStack } from '../../components-example/nativewind';
...
<CollapsibleCode>
  ```jsx %%-- File: components-example/nativewind/Switch/index.tsx --%% ```
</CollapsibleCode>
