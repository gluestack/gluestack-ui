    ...
    <Table>
      ...
      <Table.TBody>
        ...
        <Table.TR>
          ...
          <Table.TD>
            <Table.TText>{`Setting description that displays to the user. This prop only works on native.`}</Table.TText>
          </Table.TD>
        </Table.TR>
        <Table.TR>
          <Table.TD>
        ...
        <Table.TR>
          <Table.TD>
            <Table.TText>
              <InlineCode>labelTextStyle</InlineCode>
            </Table.TText>
          </Table.TD>
          <Table.TD>
        ...
        <Table.TR>
          <Table.TD>
            <Table.TText>
              <InlineCode>descriptionTextStyle</InlineCode>
            </Table.TText>
          </Table.TD>
          <Table.TD>
            <Table.TText>inherits all the properties of react native text</Table.TText>
