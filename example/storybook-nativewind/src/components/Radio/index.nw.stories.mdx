...
description: Standalone radio button for use in any layout, offering predefined choices for selection.

pageTitle: Radio

pageDescription: Standalone radio button for use in any layout, offering predefined choices for selection.
...
<Wrapper>
  <CodePreview
    ...
    metaData={{
      code: `import { Radio, RadioGroup, RadioIndicator, RadioLabel, RadioIcon } from "@/components/ui/radio";
...
<Wrapper>
  <CodePreview
    ...
    showArgsController={false}
    metaData={{
      code: `import { FormControl } from "@/components/ui/form-control";
