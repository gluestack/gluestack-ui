...
description: Easily input and customize larger amounts of text with multi-line functionality.

pageTitle: Textarea

pageDescription: Easily input and customize larger amounts of text with multi-line functionality.
...
<Meta title="with-nativewind/Components/Forms/Textarea" />
...
<>
  <CodePreview
    ...
    metaData={{
      code: `import { Textarea, TextareaInput } from "@/components/ui/textarea";
