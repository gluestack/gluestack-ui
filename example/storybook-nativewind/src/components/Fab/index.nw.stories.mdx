    ...
    metaData={{
      code: `
        function App() {
          ...
          return (
            <Box
            className='border rounded-lg border-outline-200 p-6 bg-background-200 min-w-[240px] sm:min-w-[360px] md:min-w-[476px]'
            >
              <VStack space='md'>
                {data.map((chatData)=>{
                  return (
              ...
              <Fab size='lg' className='bg-emerald-600' >
  ...
  <CodePreview
    ...
    metaData={{
      code: `
        ...
        >
          <Fab className='top-4 h-9 bg-indigo-600'>
            <FabIcon as={SearchIcon} className='mr-1.5' />
    ...
    metaData={{
      code: `
        ...
        >
          ...
          <Fab size='lg' className='bg-pink-600 right-4 bottom-16'>
