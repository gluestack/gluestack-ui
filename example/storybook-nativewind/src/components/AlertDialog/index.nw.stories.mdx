        ...
        function Example(){
          ...
          return (
            <>
              ...
              >
                <AlertDialogBackdrop />
                <AlertDialogContent className="p-0 max-w-[491px] sm:flex-row border-blue-800 rounded-xl">
                  ...
                  <AlertDialogBody
                    className=""
                    contentContainerClassName="p-6 flex-row justify-between"
                  >
                    <VStack>
                      <Heading size="md" className="text-typography-950 font-semibold">
                        The amount is successfully invested in your trading account
                      </Heading>
                      <Text className="pt-3 text-typography-950" size="sm">
                        Transaction ID:
                        <Text className="pl-3" size="sm">
                          #1234ABCDEF
                        </Text>
                      </Text>
                    </VStack>
                    <AlertDialogCloseButton className="p-0 hidden sm:flex">
                      <Icon as={CloseIcon} />
                    </AlertDialogCloseButton>
                  </AlertDialogBody>
                </AlertDialogContent>
        ...
        function Example(){
          ...
          return (
            <>
              ...
              >
                <AlertDialogBackdrop />
                <AlertDialogContent className="p-4 gap-4 max-w-[649px] w-full md:flex-row">
                  <AlertDialogBody
                    className=""
            ...
            <>
              ...
              >
                ...
                <AlertDialogContent className="w-full max-w-[415px] gap-4 items-center">
                  ...
                  <VStack>
                    <AlertDialogHeader className="mb-2 justify-center">
                      <Heading>Delete account?</Heading>
                    </AlertDialogHeader>
                    <AlertDialogBody>
                      <Text size="sm" className="text-center">
                        Lorem ipsum dolor sit amet consectetur. Nisl amet phasellus dolor orci. At arcu sit egestas at faucibus faucibus elementum mauris.
                      </Text>
                    </AlertDialogBody>
