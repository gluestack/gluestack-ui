...
import { Heading, Icon, AlertCircleIcon } from '../../components-example/themed';
import { Text, CheckCircleIcon } from '../../components-example/themed';
...
```jsx %%-- File: components-example/themed/AlertDialog/index.tsx --%% ```
