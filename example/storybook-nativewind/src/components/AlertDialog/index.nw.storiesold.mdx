...
import { Heading, Icon, AlertCircleIcon } from '../../components-example/nativewind';
import { Text, CheckCircleIcon } from '../../components-example/nativewind';
...
<CollapsibleCode>
  ```jsx %%-- File: components-example/nativewind/AlertDialog/index.tsx --%% ```
</CollapsibleCode>
