        ...
        <Table.TR>
          ...
          <Table.TD>
            <Table.TText>-</Table.TText>
             ...
             <Table.TD>
            <Table.TText>
            {`Accepts only grid-cols-* classNames. Value for * can range from 1 to 12. Default value is 12.`}</Table.TText>
          </Table.TD>
        </Table.TR>
      </Table.TBody>
    </Table>
        ...
        <Table.TR>
          ...
          <Table.TD>
            <Table.TText>-</Table.TText>
             ...
             <Table.TD>
            <Table.TText>
            {`Accepts only col-span-* classNames. Value for * can range from 1 to 12. Default value is 1.`}</Table.TText>
          </Table.TD>
        </Table.TR>
      </Table.TBody>
    </Table>
