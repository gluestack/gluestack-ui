...
import { ColorPaletteComponent } from "../../core-components/nativewind/docs-components/DefaultComponent.tsx"

<Meta title="with-nativewind/Theme Configuration/Default Tokens" />
