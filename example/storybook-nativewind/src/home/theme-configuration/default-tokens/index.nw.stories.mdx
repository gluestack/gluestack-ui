...
import {ColorPaletteComponent, ShadowComponent, SizeComponent, WeightComponent} from '../../../components/docs-components/DefaultComponent.tsx';
...
To add or update **font weights**, please refer to the [Tailwind CSS documentation](https://tailwindcss.com/docs/font-weight).  We have added two new weights in `tailwind.config.js`: '**hairline**' with a value of '**100**' and '**extraBlack**' with a value of '**950**'.
