...
- Operating System: macOS. We are currently working on support for Windows OS. For now, we recommend using the manual installation guide to avoid any issues.
