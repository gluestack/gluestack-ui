...
> Installation using gluestack-ui CLI in Expo projects supports for Expo SDK > 49 only. For Expo SDK < 49, please refer to the manual installation guide [here](https://gluestack.io/ui/docs/home/getting-started/installation).
