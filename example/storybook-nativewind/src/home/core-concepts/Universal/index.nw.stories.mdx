...
pageDescription: Universal provides gluestack snippets, offering shorthand for commonly used Universal UI components. The ultimate Universal UI component for building seamless user interfaces.

---

import { Canvas, Meta, Story } from '@storybook/addon-docs';

<Meta title="with-nativewind/Home/Core Concepts/Universal" />
