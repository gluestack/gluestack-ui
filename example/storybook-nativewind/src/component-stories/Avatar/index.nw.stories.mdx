...
<Meta title="ui/components/Avatar" />
...
import Wrapper from '../../components/nativewind/Wrapper';

This is an illustration of a **NativeWind Avatar** component with default configuration.
...
```jsx
%%-- File: components/nativewind/Avatar/index.tsx --%%
```
