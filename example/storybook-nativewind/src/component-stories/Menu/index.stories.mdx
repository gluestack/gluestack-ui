...
<Meta title="ui-nativewind/components/Menu" />
...
import { ThemeIcon, SettingsIcon, PlusIcon, Box, Button, ButtonText } from '@gluestack-ui/themed';
import { Badge, Pressable, Avatar, Divider } from '@gluestack-ui/themed';
import { Text as MenuText, Center, GlobeIcon, PuzzleIcon } from '@gluestack-ui/themed';
