...
Install `gluestack-ui` into your existing project using the following command
...
```bash
 ...
 nativewind
 ```
 Refer Step: 6 in manual installation for usage of `GluestackUIProvider`
 
### Step 4: Add components
To add components you wish to use in your project, you can use `add` command as shown below.

```bash
npx gluestack-ui add button // adds button component into the project
```
To add all the components, you can use
```bash
npx gluestack-ui add --all // adds all the components into the project
```
