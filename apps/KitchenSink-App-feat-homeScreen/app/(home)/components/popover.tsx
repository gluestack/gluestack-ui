...
const ExamplePopoverUsedAlongWithMultipleAvatars = () => {
const [isOpen, setIsOpen] = React.useState(false);
        const handleOpen = () => {
          setIsOpen(true);
        };
...
const ExamplePopoverWithInputField = () => {
...
const COMPONENT_VARIANTS = [
  ...
  },
  {
    ...
    label: "Popover with CTA",
    content: <ExamplePopoverWithCTA />,
  },
  {
    value: "popover-with-image",
    label: "Popover with Image",
    content: <ExamplePopoverWithImage />,
  },
  {
    value: "popover-with-inputfield",
    label: "Popover with InputField",
    content: <ExamplePopoverWithInputField />,
  }
];
