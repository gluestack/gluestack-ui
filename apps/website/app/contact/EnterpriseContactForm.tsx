    ...
    <Box className="pt-20 mt-56 xl:mt-24">
      <Box className="items-start lg:flex-row">
        ...
        <VStack className="justify-center mb-16 sm:mx-auto lg:w-[60%] lg:pr-2 lg:mb-0 max-w-[1000px]">
          ...
          <Text className="text-muted-foreground leading-8 mt-2 text-2xl max-w-[750px]">
          ...
          <Box className="gap-6 mt-8 sm:flex-row flex-wrap">
            <Text className="text-muted-foreground text-xl leading-7 font-medium">
              TAILORED FOR
            </Text>
            {interestOptions.map((item, index) => (
              <HStack className="gap-2 items-center" key={index}>
                ...
                {index < interestOptions.length - 1 && (
                  <Text className="text-muted-foreground text-xl leading-7">
                    |
                  </Text>
                )}
              </HStack>
        ...
        <Box className="flex-1 relative rounded-xl overflow-hidden border border-border bg-background p-8">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <Box>
              <Text className="text-sm mb-1 text-muted-foreground">
                Company <Text className="text-muted-foreground">(optional)</Text>
              </Text>
              <input
                name="company"
