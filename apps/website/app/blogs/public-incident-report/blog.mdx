...
<div className="flex items-center gap-4 mb-8 p-4 border border-red-600 shadow-soft-1 shadow-red-500 rounded-lg">
  ...
  <div>
    <div className="flex items-center gap-4 text-sm text-typography-600">
...
<div className="bg-background-50 border-l-4 border-blue-400 shadow-soft-1 shadow-blue-400 p-4 mb-6">
...
<div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
  <div className="p-4 bg-background-50 rounded-lg shadow-soft-2">
    <Package className="h-8 w-8 text-typography-600 mb-2" />
    <div className="text-2xl font-bold text-typography-900">17</div>
    <div className="text-sm text-typography-600">Packages Compromised</div>
  </div>
  <div className="p-4 bg-background-50 rounded-lg shadow-soft-2">
    <Users className="h-8 w-8 text-typography-600 mb-2" />
    <div className="text-2xl font-bold text-typography-900">1M+</div>
    <div className="text-sm text-typography-600">Weekly Downloads</div>
  </div>
  <div className="p-4 bg-background-50 rounded-lg shadow-soft-2">
    <Clock className="h-8 w-8 text-typography-600 mb-2" />
    <div className="text-2xl font-bold text-typography-900">17</div>
    <div className="text-sm text-typography-600">Hours Exposure</div>
  </div>
</div>
...
<div className="flex items-start space-x-4">
  ...
  <div>
    <h4 className="font-semibold text-typography-900">21:33 GMT - Initial Compromise</h4>
...
<div className="flex items-start space-x-4">
  ...
  <div>
    <h4 className="font-semibold text-typography-900">00:37-00:48 GMT - Attack Escalation</h4>
    <p className="text-sm text-typography-600 mb-2">8 additional packages compromised in rapid succession:</p>
...
<div className="flex items-start space-x-4">
  ...
  <div>
    <h4 className="font-semibold text-typography-900">14:28-14:46 GMT - Second Wave</h4>
    <p className="text-sm text-typography-600 mb-2">7 additional packages targeted:</p>
    <div className="bg-background-50 p-3 rounded text-xs font-mono">
      ...
      @gluestack-ui/utils-v4-experimental (0.1.16, 0.1.17)
    </div>
  </div>
</div>
</div>
...
<div className="flex items-start space-x-4">
  ...
  <div>
    <h4 className="font-semibold text-typography-900">Early Morning - Discovery and Response</h4>
...
<div className="flex items-start space-x-4">
  ...
  <div>
    <h4 className="font-semibold text-typography-900">01:22 GMT - Immediate Containment</h4>
...
<div className="flex items-start space-x-4">
  ...
  <div>
    <h4 className="font-semibold text-typography-900">Public Disclosure</h4>
...
<div className="bg-background-50 p-4 rounded-lg mb-6">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    <div>
      <p className="text-sm font-medium text-typography-700">Primary Infrastructure</p>
      <code className="text-xs bg-background-100 p-2 rounded block mt-1">
        136.0.9.8:3306<br/>
        136.0.9.8:27017
      </code>
    </div>
    <div>
      <p className="text-sm font-medium text-typography-700">Secondary Infrastructure</p>
      <code className="text-xs bg-background-100 p-2 rounded block mt-1">
...
<div className="space-y-4 mb-6">
  <div className="border border-gray-200 rounded-lg p-4">
    ...
    <p className="text-sm text-typography-600 mt-1">Harvests system metadata including OS info, Node.js version, script paths, and runtime context</p>
  </div>
  
  <div className="border border-gray-200 rounded-lg p-4">
    <code className="text-sm font-bold text-blue-600">ss_ip</code>
    <p className="text-sm text-typography-600 mt-1">Retrieves public IP address information via external API calls to <code>ip-api.com</code></p>
  </div>
</div>
...
<div className="bg-background-50 p-4 rounded-lg mb-6">
  ...
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
    <div>
      ...
      <div className="text-xs font-mono bg-background-100 p-3 rounded max-h-48 overflow-y-auto">
    ...
    <div>
      ...
      <div className="text-xs font-mono bg-background-100 p-3 rounded">
        @gluestack-ui/utils-v4-experimental@0.1.16<br/>
        @gluestack-ui/utils-v4-experimental@0.1.17
      </div>
    </div>
  </div>
</div>
...
<div className="border border-blue-600 rounded-lg p-4 shadow-soft-1 shadow-blue-500">
  ...
  <div className="bg-background-50 p-3 rounded text-sm font-mono mb-3">
    ##### Check for compromised packages<br/>
    npm list @react-native-aria/focus@0.2.10<br/>
    npm list @gluestack-ui/utils-v4-experimental@0.1.16<br/>
    npm list @gluestack-ui/utils-v4-experimental@0.1.17<br/><br/>
...
<div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
  <div className="p-4 border rounded-lg">
    ...
    <p className="text-xs text-typography-600">Mandatory 2FA for all publishing and repository access</p>
  </div>
  <div className="p-4 border rounded-lg">
    <FileText className="h-6 w-6 text-green-600 mb-2" />
    <h5 className="font-semibold text-sm">Code Integrity</h5>
    <p className="text-xs text-typography-600">Cryptographic signing and continuous security scanning</p>
  </div>
  <div className="p-4 border rounded-lg">
    <Network className="h-6 w-6 text-purple-600 mb-2" />
    <h5 className="font-semibold text-sm">Monitoring</h5>
    <p className="text-xs text-typography-600">AI-powered detection and threat intelligence integration</p>
  </div>
</div>
...
<div className="border border-gray-200 rounded-lg p-4 mb-6">
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
    <div>
      ...
      <span className="ml-2 text-typography-600">CVE-2025-XXXX (Pending)</span>
    </div>
    <div>
    ...
    <div>
      ...
      <span className="ml-2 text-typography-600">CWE-506</span>
    </div>
  </div>
</div>
...
<div className="mt-8 p-4 bg-background-50 border-l-4 border-gray-400 text-sm text-typography-600">
