...
import { useBreakpointValue } from '@gluestack-ui/utils-v4-experimental/hooks';
...
This is an illustration of **useBreakPointValue** hook.
  ...
  importMap={{"@gluestack-ui/utils-v4-experimental/hooks":["useBreakpointValue"],"@/components/ui/vstack":["VStack"],"@/components/ui/box":["Box"],"@/components/ui/text":["Text"]}}
/>
