import { Meta } from '@/components/custom/meta';
  ...
  <Meta pageTitle="Installation" pageDescription="Quickly set up gluestack-ui, the ultimate UI components library. Build modern, scalable interfaces effortlessly with our easy installation guide." />
