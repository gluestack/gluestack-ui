...
```bash
yarn add @gluestack-ui/core-v4-experimental @gluestack-ui/utils-v4-experimental react-native-svg @gluestack/ui-next-adapter react-native-web react-native
```

OR

```bash
npm i @gluestack-ui/core-v4-experimental @gluestack-ui/utils-v4-experimental react-native-svg @gluestack/ui-next-adapter react-native-web react-native
```

For Next.js 14, it's recommended to use the `--legacy-peer-deps` flag due to peer dependency resolution issues.

```bash
npm i @gluestack-ui/core-v4-experimental @gluestack-ui/utils-v4-experimental react-native-svg @gluestack/ui-next-adapter react-native-web react-native --legacy-peer-deps
```
