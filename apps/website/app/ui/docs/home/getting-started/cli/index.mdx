...
- `--nativewind-v5`: Use NativeWind v5 (Tailwind CSS v4) as the styling engine. This is the default for new projects.

- `--uniwind`: Use UniWind (Tailwind CSS v4, Expo-only) as the styling engine. UniWind has no PostCSS build step.
