...
This is an illustration of **Fab** component.
  ...
  importMap={{"@/components/ui/box":["Box"],"@/components/ui/fab":["Fab","FabIcon","FabLabel"],"@/components/ui/icon":["AddIcon"]}}
/>
...
The Examples section provides visual representations of the different variants of the component, allowing you to quickly and easily determine which one best fits your needs. Simply copy the code and integrate it into your project.
  ...
  importMap={{"@/components/ui/fab":["Fab","FabIcon"],"@/components/ui/box":["Box"],"@/components/ui/vstack":["VStack"],"@/components/ui/hstack":["HStack"],"@/components/ui/avatar":["Avatar","AvatarImage"],"@/components/ui/heading":["Heading"],"@/components/ui/text":["Text"],"@/components/ui/icon":["EditIcon"]}}
/>
  ...
  importMap={{"@/components/ui/fab":["Fab","FabIcon","FabLabel"],"@/components/ui/box":["Box"],"@/components/ui/vstack":["VStack"],"@/components/ui/hstack":["HStack"],"@/components/ui/heading":["Heading"],"@/components/ui/text":["Text"],"@/components/ui/divider":["Divider"],"@/components/ui/icon":["SearchIcon"]}}
/>
  ...
  importMap={{"@/components/ui/fab":["Fab","FabIcon"],"@/components/ui/box":["Box"],"@/components/ui/vstack":["VStack"],"@/components/ui/checkbox":["Checkbox","CheckboxIndicator","CheckboxLabel","CheckboxIcon"],"@/components/ui/text":["Text"],"@/components/ui/icon":["AddIcon","CheckIcon"]}}
/>
  ...
  importMap={{"@/components/ui/fab":["Fab","FabIcon"],"@/components/ui/box":["Box"],"@/components/ui/vstack":["VStack"],"@/components/ui/heading":["Heading"],"@/components/ui/text":["Text"],"@/components/ui/image":["Image"],"@/components/ui/link":["Link"],"lucide-react-native":["ShoppingCartIcon"]}}
/>