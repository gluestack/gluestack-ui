...
<CodePreviewer
  ...
  importMap={{
    ...
    '@/components/ui/fab': ['Fab', 'FabIcon', 'FabLabel'],
    '@/components/ui/icon': ['AddIcon'],
  }}
/>
...
<CodePreviewer
  ...
  importMap={{
    '@/components/ui/fab': ['Fab', 'FabIcon'],
    '@/components/ui/box': ['Box'],
    '@/components/ui/vstack': ['VStack'],
    '@/components/ui/hstack': ['HStack'],
    '@/components/ui/avatar': ['Avatar', 'AvatarImage'],
...
<CodePreviewer
  ...
  importMap={{
    ...
    '@/components/ui/text': ['Text'],
    '@/components/ui/icon': ['AddIcon', 'CheckIcon'],
  }}
/>
...
<CodePreviewer
  ...
  importMap={{
    ...
    'lucide-react-native': ['ShoppingCartIcon'],
  }}
/>
