...
<TableBody>
  ...
  <TableRow>
    <TableCell><InlineCode>focus</InlineCode></TableCell>
...
<TableBody>
  ...
  <TableRow>
    <TableCell><InlineCode>placement</InlineCode></TableCell>
    <TableCell>top right | top left | bottom right | bottom left | top center | bottom center</TableCell>
    <TableCell>bottom right</TableCell>
  </TableRow>
</TableBody>
</Table>
...
<CodePreviewer
  ...
  title="FAB with Icon"
  description="A Fab component with an icon adds a visually striking and easily recognizable button that triggers a specific action or function within a user interface."
/>
...
<CodePreviewer
  ...
  title="FAB with Icon and Text"
  description="A Fab component with an icon and text combines a visual icon with accompanying text to create a prominent and descriptive button that triggers a specific action or function within a user interface."
/>
...
<CodePreviewer
  ...
  title="Placement"
  description="A Fab component with placement options allows for flexible positioning of the button within a user interface, enabling convenient and intuitive access to key actions or functionalities in various locations."
/>
...
<CodePreviewer
  ...
  description="A Fab component with custom placement allows for flexible positioning of the button according to specific design requirements or user interface preferences, providing tailored and intuitive access to key actions or functionalities."
/>