...
import { Meta } from '@/components/custom/meta';
  ...
  <Meta pageTitle="Popover" pageDescription="Improve user experience with a React Popover component—perfect for contextual modals, tooltips & interactive UI elements. Works seamlessly in React & React Native!" />
