...
<CodePreviewer
  ...
  description="An example of the Badge component being used with the Avatar component to display badges alongside user avatars for enhanced visual representation or identification."
/>
...
<CodePreviewer
  ...
  description="An example of the Badge component being used with the Composition component, allowing for the display of badges within a composition of other UI elements."
/>