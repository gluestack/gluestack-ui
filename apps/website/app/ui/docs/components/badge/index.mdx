...
<Meta pageTitle="Badge" pageDescription="Enhance your app with gluestack-ui's Badge component. A versatile React Native badge with multiple variants for clear status indicators in your badges component." />
