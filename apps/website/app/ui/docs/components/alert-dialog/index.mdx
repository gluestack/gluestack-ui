...
import { Meta } from '@/components/custom/meta';
  ...
  <Meta pageTitle="AlertDialog" pageDescription="Build seamless React Native dialogs with the AlertDialog component. Enhance user engagement with smooth and responsive modal prompts." />
