...
import { AdvancedComponentLLMGenerator } from '@/components/custom/component-llm-generator/advanced';
...
<AdvancedComponentLLMGenerator 
  componentName="Button" 
  componentPath="/ui/docs/components/button"
  mdxContent={`
# Button
...
To use this component in your project, include the following imports:
...
- **Root**: The main container element
- **Text**: The text content within the button
- **Icon**: Optional icon component
- **Spinner**: Optional loading indicator

Below is a visual representation of the Button component's anatomy:
...
The Button component can be used in various ways depending on your needs. Here are some common examples:
  ...
  <Table>
    ...
    <TableBody>
      <TableRow>
        ...
        <TableCell>Changes the visual style of the button</TableCell>
      </TableRow>
      <TableRow>
        <TableCell>
        ...
        <TableCell>Changes the size of the button</TableCell>
      </TableRow>
      <TableRow>
        <TableCell>
      ...
      <TableRow>
        ...
        <TableCell>boolean</TableCell>
        <TableCell>false</TableCell>
        <TableCell>Indicates if the button has focus</TableCell>
      </TableRow>
      <TableRow>
        <TableCell>
        ...
        <TableCell>boolean</TableCell>
        <TableCell>false</TableCell>
        <TableCell>Indicates if the button is hovered</TableCell>
      </TableRow>
      <TableRow>
        <TableCell>
        ...
        <TableCell>boolean</TableCell>
        <TableCell>false</TableCell>
        <TableCell>Indicates if the button is pressed</TableCell>
      </TableRow>
      <TableRow>
        <TableCell>
