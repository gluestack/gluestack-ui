...
<CodePreviewer
  ...
  importMap={{
    '@/components/ui/button': ['Button', 'ButtonText', 'ButtonSpinner'],
  }}
/>
...
<CodePreviewer
  ...
  importMap={{
    '@/components/ui/button': ['Button', 'ButtonIcon'],
    '@/components/ui/icon': ['EditIcon'],
  }}
/>
...
<CodePreviewer
  ...
  importMap={{
    ...
    '@/components/ui/icon': ['ArrowUpIcon'],
  }}
/>
...
<CodePreviewer
  ...
  importMap={{
    ...
    '@/components/ui/icon': ['InfoIcon', 'AddIcon'],
  }}
/>
