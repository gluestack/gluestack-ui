...
<CodePreviewer
  ...
  description="The following example demonstrates how easily you can customize the Accordion component to suit your needs."
/>
...
<CodePreviewer
  ...
  description="The borderRadius prop can be used to create rounded corners for both the Accordion and AccordionItem components."
/>
