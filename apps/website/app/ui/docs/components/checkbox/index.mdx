...
import { Meta } from '@/components/custom/meta';
  ...
  <Meta pageTitle="Checkbox" pageDescription="Build interactive forms with a checkbox component for React & React Native. Features include hover, focus, disabled states, and multiple checkbox selection." />
