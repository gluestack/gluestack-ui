  ...
  <Table>
    ...
    <TableBody>
      <TableRow>
        ...
        <TableCell>-</TableCell>
        <TableCell>The value to be used in the checkbox input. This is the value that will be returned on form submission.</TableCell>
      </TableRow>
      <TableRow>
        <TableCell><InlineCode>onChange</InlineCode></TableCell>
        <TableCell>(value: boolean) => void</TableCell>
        <TableCell>-</TableCell>
        <TableCell>Function called when the state of the checkbox changes.</TableCell>
      </TableRow>
      <TableRow>
        <TableCell><InlineCode>defaultIsChecked</InlineCode></TableCell>
        <TableCell>bool</TableCell>
        <TableCell>false</TableCell>
        <TableCell>If true, the checkbox will be initially checked.</TableCell>
      </TableRow>
      <TableRow>
        <TableCell><InlineCode>isChecked</InlineCode></TableCell>
        <TableCell>bool</TableCell>
        <TableCell>false</TableCell>
        <TableCell>When true, the checkbox will be checked. You'll need to pass onChange to update it's value (since it's now controlled).</TableCell>
      </TableRow>
      <TableRow>
      ...
      <TableRow>
        <TableCell><InlineCode>isFocusVisible</InlineCode></TableCell>
        <TableCell>bool</TableCell>
        <TableCell>false</TableCell>
        <TableCell>To manually set focus visible state to the checkbox.</TableCell>
      </TableRow>
      <TableRow>
        <TableCell><InlineCode>isIndeterminate</InlineCode></TableCell>
        <TableCell>bool</TableCell>
        <TableCell>false</TableCell>
  ...
  <Table>
    ...
    <TableBody>
      ...
      <TableRow>
        ...
        <TableCell>-</TableCell>
        <TableCell>The callback fired when any children Checkbox is checked or unchecked.</TableCell>
      </TableRow>
      <TableRow>
        <TableCell><InlineCode>isDisabled</InlineCode></TableCell>
        <TableCell>bool</TableCell>
...
<>
  <Table>
    ...
    <TableBody>
      <TableRow>
        <TableCell><InlineCode>hover</InlineCode></TableCell>
        <TableCell>data-hover</TableCell>
        <TableCell><InlineCode>true | false</InlineCode></TableCell>
      </TableRow>
      <TableRow>
        <TableCell><InlineCode>active</InlineCode></TableCell>
      ...
      <TableRow>
        <TableCell><InlineCode>focusVisible</InlineCode></TableCell>
      ...
      <TableRow>
        <TableCell><InlineCode>checked</InlineCode></TableCell>
...
<CodePreviewer
  ...
  description="Checkbox provide a mutually exclusive selection mechanism, allowing users to choose a multiple option from a set of related choices."
/>
...
<CodePreviewer
  ...
  title="Horizontal"
  description="A horizontal component incorporating a checkbox allows for intuitive and space-efficient selection of multiple options within a linear layout."
/>
...
<CodePreviewer
  ...
  description="A checkbox component with help text provides informative guidance alongside selectable options, ensuring clarity and ease of use."
/>
...
<CodePreviewer
  ...
  title="Form Control"
  description="A checkbox component integrated with form control enhances the user experience by enabling easy selection and submission of options within a structured input context."
/>
...
<CodePreviewer
  ...
  reactLive={{ Checkbox, CheckboxGroup, CheckboxIndicator, CheckboxIcon, CheckboxLabel, VStack, CheckIcon }}
  title="Label Left"
  description="A checkbox component with Label left configuration aligns the label to the left, facilitating clear association between the option and its corresponding checkbox."
/>
...
<CodePreviewer
  ...
  reactLive={{ Checkbox, CheckboxGroup, CheckboxIndicator, CheckboxIcon, CheckboxLabel, VStack, CheckIcon }}
  title="Controlled"
  description="A controlled component architecture incorporates a checkbox component, allowing for precise management of its state and behavior through explicit control mechanisms."
/>
...
<CodePreviewer
  ...
  reactLive={{ Checkbox, CheckboxGroup, CheckboxIndicator, CheckboxIcon, CheckboxLabel, VStack, CheckIcon }}
  title="Uncontrolled"
  description="An uncontrolled component utilizes a checkbox component, providing a simpler implementation where the checkbox state is managed internally, without explicit control from external sources."
/>
...
<CodePreviewer
  ...
  description="The checkbox group component allows users to group checkbox and display them in a horizontal or vertical row for better visual representation and functionality."
/>