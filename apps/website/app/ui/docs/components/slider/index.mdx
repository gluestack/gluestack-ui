...
import { Meta } from '@/components/custom/meta';
  ...
  <Meta pageTitle="Slider" pageDescription="Create smooth, interactive controls with the gluestack-ui React Native Slider component. Customize track height, values, and states for a seamless slider UI experience." />
