...
import { Meta } from '@/components/custom/meta';
  ...
  <Meta pageTitle="Menu" pageDescription="Build a user-friendly interface with gluestack-ui menu component in React & React Native, designed for easy navigation and accessibility." />
