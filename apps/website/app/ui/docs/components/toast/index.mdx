...
import { Meta } from '@/components/custom/meta';
  ...
  <Meta pageTitle="Toast" pageDescription="gluestack-ui Toast component for React Native lets you show toast messages effortlessly. Improve your Toast component with flexible placement, duration, and actions." />
