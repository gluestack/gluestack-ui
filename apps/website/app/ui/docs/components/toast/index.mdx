...
<CodePreviewer
  ...
  importMap={{
    ...
    '@/components/ui/icon': ['Icon', 'CloseIcon', 'HelpCircleIcon'],
...
<CodePreviewer
  ...
  importMap={{
    ...
    '@/components/ui/button': ['Button', 'ButtonText', 'ButtonGroup'],
    '@/components/ui/pressable': ['Pressable'],
    '@/components/ui/icon': ['Icon', 'CloseIcon'],
    '@/components/ui/hstack': ['HStack'],
    '@/components/ui/vstack': ['VStack'],
    '@/components/ui/box': ['Box'],
    'lucide-react-native': ['RefreshCw'],
  }}
/>
...
<CodePreviewer
  ...
  importMap={{
    '@/components/ui/toast': ['Toast', 'ToastTitle', 'useToast'],
    '@/components/ui/button': ['Button', 'ButtonText'],
    '@/components/ui/icon': ['Icon'],
    'lucide-react-native': ['Send'],
