...
import { Meta } from '@/components/custom/meta';
  ...
  <Meta pageTitle="Actionsheet" pageDescription="Discover the ActionSheet component for Expo, React & React Native. Easily create intuitive action sheets in your app with gluestack-ui. Learn more in our detailed documentation!" />
