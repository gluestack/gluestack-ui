...
<CodePreviewer
  ...
  importMap={{
    ...
    '@/components/ui/button': ['ButtonGroup', 'Button', 'ButtonText'],
    ...
    '@/components/ui/icon': ['Icon', 'CloseIcon'],
    'lucide-react-native': ['UploadCloud'],
    '@/components/ui/pressable': ['Pressable'],
  }}
/>
