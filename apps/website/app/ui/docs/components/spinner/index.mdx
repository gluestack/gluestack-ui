...
import { Meta } from '@/components/custom/meta';
  ...
  <Meta pageTitle="Spinner" pageDescription="Enhance your UI with the gluestack-ui Spinner component. A React Native spinner with ShadCN styling for smooth loading indicators. Optimize your spinner UI design with ease." />
