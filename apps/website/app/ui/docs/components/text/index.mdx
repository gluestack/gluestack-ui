...
```jsx 
<!-- Failed to load file: core-components/nativewind/text/index.tsx  --> 
```
...
```jsx 
<!-- Failed to load file: core-components/nativewind/text/index.web.tsx  --> 
```

### Step 3: Copy and paste the following code into styles.tsx in your project.

```jsx 
<!-- Failed to load file: core-components/nativewind/text/styles.tsx  --> 
```
