...
This is an illustration of **Chat AI** components.
  ...
  importMap={{"@/components/ui/chat-ai":["Conversation","ConversationContent","Message","MessageContent","MessageResponse","MessageToolbar","MessageAction","PromptInput","PromptInputProvider","PromptInputBody","PromptInputTextarea","ConversationScrollButton"],"@/components/ui/box":["Box"]}}
