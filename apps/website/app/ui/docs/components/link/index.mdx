...
import { Meta } from '@/components/custom/meta';
  ...
  <Meta pageTitle="Link" pageDescription="Enhance navigation with a React Native link component. Seamless UI link design for intuitive user experiences. Learn more!" />
