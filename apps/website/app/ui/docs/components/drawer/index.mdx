...
<Meta pageTitle="Drawer" pageDescription="Implement a responsive Drawer component in React & React Native for navigation and content display. Learn how to install, customize, and integrate it into your project." />
  ...
  <Table>
    ...
    <TableBody>
      <TableRow>
        ...
        <TableCell>-</TableCell>
        <TableCell>If true, the drawer will open. Useful for controllable state behavior.</TableCell>
      </TableRow>
      <TableRow>
      ...
      <TableRow>
        ...
        <TableCell>-</TableCell>
        <TableCell>The ref of element to receive focus when the drawer opens.</TableCell>
      </TableRow>
      <TableRow>
        <TableCell><InlineCode>finalFocusRef</InlineCode></TableCell>
        <TableCell>{`React.RefObject<any>`}</TableCell>
        <TableCell>-</TableCell>
        <TableCell>The ref of element to receive focus when the drawer closes</TableCell>
      </TableRow>
      <TableRow>
      ...
      <TableRow>
        ...
        <TableCell>boolean</TableCell>
        <TableCell>-</TableCell>
        <TableCell>If true, the Drawer will close when the overlay is clicked.</TableCell>
      </TableRow>
      <TableRow>
...
<>
  <Table>
    ...
    <TableBody>
      <TableRow>
        <TableCell><InlineCode>focusable</InlineCode></TableCell>
        <TableCell>boolean</TableCell>
...
<>
  <Table>
    ...
    <TableBody>
      ...
      <TableRow>
        <TableCell><InlineCode>anchor</InlineCode></TableCell>
