...
import { Meta } from '@/components/custom/meta';
  ...
  <Meta pageTitle="Skeleton" pageDescription="Discover the ultimate gluestack-ui Skeleton component for React & React Native. Improve app loading visuals with gluestack-ui easy-to-use Skeleton." />
