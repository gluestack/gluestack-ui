...
<CodePreviewer
  ...
  importMap={{
    ...
    '@/components/ui/button': ['Button', 'ButtonText', 'ButtonIcon'],
    '@/components/ui/heading': ['Heading'],
    '@/components/ui/text': ['Text'],
    '@/components/ui/hstack': ['HStack'],
    '@/components/ui/input': ['Input', 'InputField'],
    '@/components/ui/link': ['Link', 'LinkText'],
    '@/components/ui/icon': ['ArrowLeftIcon'],
  }}
/>
...
<CodePreviewer
  ...
  importMap={{
    ...
    '@/components/ui/heading': ['Heading'],
    '@/components/ui/text': ['Text'],
    '@/components/ui/icon': ['Icon', 'TrashIcon'],
...
<CodePreviewer
  ...
  importMap={{
    ...
    '@/components/ui/icon': ['Icon', 'CloseIcon', 'CopyIcon'],
    '@/components/ui/input': ['Input', 'InputField'],
