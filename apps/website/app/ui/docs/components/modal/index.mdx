...
This is an illustration of **Modal** component.
  ...
  importMap={{"@/components/ui/modal":["Modal","ModalBackdrop","ModalContent","ModalHeader","ModalCloseButton","ModalBody","ModalFooter"],"@/components/ui/button":["Button","ButtonText"],"@/components/ui/heading":["Heading"],"@/components/ui/text":["Text"],"@/components/ui/icon":["Icon","CloseIcon"]}}
...
It is React Native's [Pressable](https://reactnative.dev/docs/pressable#props) component, created using [react-native-reanimated's](https://docs.swmansion.com/react-native-reanimated/) `Animated.createAnimatedComponent` function to add animation to the component.

#### ModalContent

It is [react-native-reanimated's](https://docs.swmansion.com/react-native-reanimated/) [Animated.View](https://docs.swmansion.com/react-native-reanimated/docs/fundamentals/glossary#animatedview) component.
...
The Examples section provides visual representations of the different variants of the component, allowing you to quickly and easily determine which one best fits your needs. Simply copy the code and integrate it into your project.
  ...
  importMap={{"@/components/ui/modal":["Modal","ModalBackdrop","ModalContent","ModalHeader","ModalBody","ModalFooter"],"@/components/ui/button":["Button","ButtonText","ButtonIcon"],"@/components/ui/heading":["Heading"],"@/components/ui/text":["Text"],"@/components/ui/hstack":["HStack"],"@/components/ui/input":["Input","InputField"],"@/components/ui/link":["Link","LinkText"],"@/components/ui/icon":["ArrowLeftIcon"]}}
...
/>
  ...
  importMap={{"@/components/ui/modal":["Modal","ModalBackdrop","ModalContent","ModalBody","ModalFooter"],"@/components/ui/button":["Button","ButtonText"],"@/components/ui/heading":["Heading"],"@/components/ui/text":["Text"],"@/components/ui/image":["Image"]}}
...
/>
  ...
  importMap={{"@/components/ui/modal":["Modal","ModalBackdrop","ModalContent","ModalHeader","ModalBody","ModalFooter"],"@/components/ui/button":["Button","ButtonText"],"@/components/ui/heading":["Heading"],"@/components/ui/text":["Text"],"@/components/ui/icon":["Icon","TrashIcon"],"@/components/ui/box":["Box"]}}
...
/>
  ...
  importMap={{"@/components/ui/modal":["Modal","ModalBackdrop","ModalContent","ModalHeader","ModalCloseButton","ModalBody"],"@/components/ui/button":["Button","ButtonText"],"@/components/ui/heading":["Heading"],"@/components/ui/text":["Text"],"@/components/ui/vstack":["VStack"],"@/components/ui/icon":["Icon","CloseIcon","CopyIcon"],"@/components/ui/input":["Input","InputField"],"@/components/ui/pressable":["Pressable"]}}
