...
import { Meta } from '@/components/custom/meta';
  ...
  <Meta pageTitle="Modal" pageDescription="Create smooth and accessible modals in React & React Native. Implement React modal components for alerts, forms, and notifications with ease. Optimize modal component for better user engagement." />
...
<TableBody>
  <TableRow>
    ...
    <TableCell>-</TableCell>
    <TableCell>If true, the modal will open. Useful for controllable state behavior</TableCell>
  </TableRow>
  <TableRow>
  ...
  <TableRow>
    ...
    <TableCell>-</TableCell>
    <TableCell>The ref of element to receive focus when the modal opens</TableCell>
  </TableRow>
  <TableRow>
    <TableCell><InlineCode>finalFocusRef</InlineCode></TableCell>
    <TableCell>{'React.RefObject<any>'}</TableCell>
    <TableCell>-</TableCell>
    <TableCell>The ref of element to receive focus when the modal closes</TableCell>
  </TableRow>
  <TableRow>
  ...
  <TableRow>
    ...
    <TableCell>boolean</TableCell>
    <TableCell>-</TableCell>
    <TableCell>If true, the Modal will close when the overlay is clicked</TableCell>
  </TableRow>
  <TableRow>
