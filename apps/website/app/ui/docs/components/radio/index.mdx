...
This is an illustration of **Radio** component.
  ...
  importMap={{"@/components/ui/radio":["Radio","RadioGroup","RadioIndicator","RadioIcon","RadioLabel"],"@/components/ui/icon":["CircleIcon"]}}
/>
...
import { tva, useStyleContext } from '@gluestack-ui/utils-v4-experimental/nativewind-utils';
...
The Examples section provides visual representations of the different variants of the component, allowing you to quickly and easily determine which one best fits your needs. Simply copy the code and integrate it into your project.
  ...
  importMap={{"@/components/ui/center":["Center"],"@/components/ui/vstack":["VStack"],"@/components/ui/radio":["Radio","RadioGroup","RadioIcon","RadioIndicator","RadioLabel"],"@/components/ui/icon":["CircleIcon"]}}
/>
  ...
  importMap={{"@/components/ui/center":["Center"],"@/components/ui/hstack":["HStack"],"@/components/ui/radio":["Radio","RadioGroup","RadioIcon","RadioIndicator","RadioLabel"],"@/components/ui/icon":["CircleIcon"]}}
/>
  ...
  importMap={{"@/components/ui/center":["Center"],"@/components/ui/vstack":["VStack"],"@/components/ui/radio":["Radio","RadioGroup","RadioIcon","RadioIndicator","RadioLabel"],"@/components/ui/icon":["CircleIcon"],"@/components/ui/box":["Box"],"@/components/ui/text":["Text"]}}
/>
  ...
  importMap={{"@/components/ui/center":["Center"],"@/components/ui/text":["Text"],"@/components/ui/icon":["CircleIcon"],"@/components/ui/vstack":["VStack"],"@/components/ui/heading":["Heading"],"@/components/ui/radio":["Radio","RadioGroup","RadioIcon","RadioIndicator","RadioLabel"],"@/components/ui/form-control":["FormControl"]}}
/>
...
/>
  ...
  importMap={{"@/components/ui/radio":["Radio","RadioGroup","RadioIcon","RadioIndicator","RadioLabel"],"@/components/ui/vstack":["VStack"],"@/components/ui/center":["Center"],"@/components/ui/icon":["CircleIcon"]}}
/>