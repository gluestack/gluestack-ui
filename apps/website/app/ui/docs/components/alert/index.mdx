...
<CodePreviewer
  ...
  importMap={{
    '@/components/ui/alert': ['Alert', 'AlertText', 'AlertIcon'],
    '@/components/ui/icon': ['InfoIcon'],
  }}
/>
...
<CodePreviewer
  ...
  importMap={{
    '@/components/ui/alert': ['Alert', 'AlertText'],
...
<CodePreviewer
  ...
  importMap={{
    ...
    '@/components/ui/text': ['Text'],
    '@/components/ui/icon': ['EyeIcon', 'EyeOffIcon', 'InfoIcon'],
  }}
/>
