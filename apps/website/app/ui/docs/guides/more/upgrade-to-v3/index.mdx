...
- **Package structure changes** to @gluestack-ui/core and @gluestack-ui/core
...
**After:**
<CodeBlock code={`import { flush } from '@gluestack-ui/core/nativewind-utils';`} language="typescript" />
...
<Tabs>
<TabItem label="npm">
<CodeBlock code="npm install @gluestack-ui/core@latest @gluestack-ui/core@latest react-native-svg@15.12.0 @gluestack/ui-next-adapter@latest" language="bash" />
</TabItem>
<TabItem label="yarn">
<CodeBlock code="yarn add @gluestack-ui/core@latest @gluestack-ui/core@latest react-native-svg@15.12.0 @gluestack/ui-next-adapter@latest" language="bash" />
</TabItem>
<TabItem label="pnpm">
<CodeBlock code="pnpm i @gluestack-ui/core@latest @gluestack-ui/core@latest react-native-svg@15.12.0 @gluestack/ui-next-adapter@latest" language="bash" />
</TabItem>
<TabItem label="bun">
<CodeBlock code="bun add @gluestack-ui/core@latest @gluestack-ui/core@latest react-native-svg@15.12.0 @gluestack/ui-next-adapter@latest" language="bash" />
</TabItem>
</Tabs>
...
**After:**
<CodeBlock code={`import { flush } from '@gluestack-ui/core/nativewind-utils';
import { tva } from '@gluestack-ui/core/nativewind-utils';`} language="typescript" />
...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell>
        <InlineCode>{`from '@gluestack-ui/core/nativewind-utils'`}</InlineCode>
      </TableCell>
    </TableRow>
    <TableRow>
      <TableCell>
