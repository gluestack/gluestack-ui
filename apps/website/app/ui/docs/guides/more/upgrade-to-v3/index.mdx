...
- **Package structure changes** to @gluestack-ui/core-v4-experimental and @gluestack-ui/utils-v4-experimental
- **Import path updates** for creator function
- **ARIA dependencies** moved from react-native-aria to @gluestack-ui/core-v4-experimental
...
**After:**
<CodeBlock code={`import { flush } from '@gluestack-ui/utils-v4-experimental/nativewind-utils';`} language="typescript" />
...
<Tabs>
<TabItem label="npm">
<CodeBlock code="npm install @gluestack-ui/core-v4-experimental@latest @gluestack-ui/utils-v4-experimental@latest react-native-svg@15.12.0 @gluestack/ui-next-adapter@latest" language="bash" />
</TabItem>
<TabItem label="yarn">
<CodeBlock code="yarn add @gluestack-ui/core-v4-experimental@latest @gluestack-ui/utils-v4-experimental@latest react-native-svg@15.12.0 @gluestack/ui-next-adapter@latest" language="bash" />
</TabItem>
<TabItem label="pnpm">
<CodeBlock code="pnpm i @gluestack-ui/core-v4-experimental@latest @gluestack-ui/utils-v4-experimental@latest react-native-svg@15.12.0 @gluestack/ui-next-adapter@latest" language="bash" />
</TabItem>
<TabItem label="bun">
<CodeBlock code="bun add @gluestack-ui/core-v4-experimental@latest @gluestack-ui/utils-v4-experimental@latest react-native-svg@15.12.0 @gluestack/ui-next-adapter@latest" language="bash" />
</TabItem>
</Tabs>
...
import { createRadio } from '@gluestack-ui/core-v4-experimental/radio/creator';`} language="typescript" />
...
**After:**
<CodeBlock code={`import { flush } from '@gluestack-ui/utils-v4-experimental/nativewind-utils';
import { tva } from '@gluestack-ui/utils-v4-experimental/nativewind-utils';`} language="typescript" />
...
<Table>
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell>
        <InlineCode>{`from '@gluestack-ui/core-v4-experimental/[component]/creator'`}</InlineCode>
      </TableCell>
    </TableRow>
    <TableRow>
      <TableCell>
      ...
      <TableCell>
        <InlineCode>{`from '@gluestack-ui/utils-v4-experimental/nativewind-utils'`}</InlineCode>
      </TableCell>
    </TableRow>
    <TableRow>
      <TableCell>
