              ...
              >
                ...
                <VStack className="gap-5 mt-8">
                  ...
                  <HStack className="gap-5 items-center">
                    ...
                    >
                      <Icon size="xl" as={Type} className="text-primary-700" />
                    </Box>
                    <HStack className="border-b border-border pb-2  items-center flex-1">
                      <VStack className=" flex-1">
                        <Text className="text-sm font-bold text-foreground">
            ...
            <HStack className="gap-3 items-start self-stretch">
              ...
              >
                <svg
                  ...
                  className="fill-foreground"
                >
                  <path d="M15.6875 6.53112H15.0833V6.5H8.33334V9.5H12.572C11.9536 11.2464 10.292 12.5 8.33334 12.5C5.84822 12.5 3.83334 10.4851 3.83334 8C3.83334 5.51487 5.84822 3.5 8.33334 3.5C9.48047 3.5 10.5241 3.93275 11.3187 4.63962L13.4401 2.51825C12.1006 1.26987 10.3088 0.5 8.33334 0.5C4.19147 0.5 0.833344 3.85812 0.833344 8C0.833344 12.1419 4.19147 15.5 8.33334 15.5C12.4752 15.5 15.8333 12.1419 15.8333 8C15.8333 7.49712 15.7816 7.00625 15.6875 6.53112Z" />
                  <path d="M1.69809 4.50912L4.16221 6.31625C4.82896 4.6655 6.44372 3.5 8.33334 3.5C9.48047 3.5 10.5241 3.93275 11.3187 4.63962L13.4401 2.51825C12.1006 1.26987 10.3088 0.5 8.33334 0.5C5.45259 0.5 2.95434 2.12637 1.69809 4.50912Z" />
                  <path d="M8.33346 15.4993C10.2707 15.4993 12.031 14.7579 13.3618 13.5523L11.0406 11.588C10.2876 12.1584 9.35159 12.4993 8.33346 12.4993C6.38271 12.4993 4.72634 11.2554 4.10234 9.51953L1.65659 11.4039C2.89784 13.8328 5.41859 15.4993 8.33346 15.4993Z" />
                  <path d="M15.6875 6.53113H15.0833V6.5H8.33334V9.5H12.572C12.275 10.3389 11.7353 11.0622 11.0393 11.5891L11.0405 11.5884L13.3617 13.5526C13.1975 13.7019 15.8333 11.75 15.8333 8C15.8333 7.49713 15.7816 7.00625 15.6875 6.53113Z" />
                </svg>
              </Button>
              <Button
                className={`${getBorderStyle(activeButton, 'button')} flex-1`}
...
export default function Fold3Interactive() {
  return (
    <LocalThemeProvider>
      <Fold3InteractiveContent />
    </LocalThemeProvider>
  );
}
