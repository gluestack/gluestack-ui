...
import DatingAppLogo from '@/public/icon/logo/theappmarket/dating-app.svg';
import FitnessAppLogo from '@/public/icon/logo/theappmarket/fitness-app.svg';
import MeditationAppLogo from '@/public/icon/logo/theappmarket/meditation-app.svg';
import FAQLogo from '@/public/icon/favicons/faq.svg';
import FAQDarkLogo from '@/public/icon/favicons/faq-dark.svg';
import { Badge, BadgeText, Box, Image } from '@/components/ui';
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        logo: (
          <Image alt="dark mode" className="w-5 h-5" size="md" src={FAQLogo} />
        ),
        logoDark: (
          <Image
            alt="dark mode"
