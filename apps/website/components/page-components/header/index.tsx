        ...
        >
          ...
          <div className="flex flex-row xl:gap-10 gap-6 items-center ">
            ...
            <div className="flex flex-row items-center gap-4">
              ...
              >
                <div className="flex flex-row items-center gap-1 w-[46px]">
                  <svg
              ...
              {!isDocsRoute && (
                <Link
                  ...
                  className="border border-border rounded-full px-4 py-1.5 xl:flex hidden"
                >
              ...
              {!isDocsRoute ? (
                ...
                >
                  <Button className="rounded-full shadow-none px-4" size="sm">
                    Get Started
                  </Button>
                </NextLink>
              ) : (
                <HStack className="gap-3">
                  ...
                  >
                    <Text className="text-sm text-foreground">Get Updates</Text>
                  </Link>
                  <NewsletterModal
                    showModal={showModal}
