...
const SocialLinksOptions = [
  ...
  },
  {
    href: '/support',
    title: 'Support',
    description: 'Get professional support and help for your projects.',
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  },
  {
    href: '/contact',
    title: 'Enterprise',
    description: 'Custom plans, support, and licensing for teams.',
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  },
  {
    href: '/community',
    title: 'Interns & CFP',
    description: 'Join our internship program or submit a CFP.',
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
