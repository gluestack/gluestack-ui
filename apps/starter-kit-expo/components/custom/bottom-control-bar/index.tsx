...
import { ThemeBase, useAppTheme } from '@/contexts/app-theme-context';
      ...
      <>
        ...
        {components && components.length > 0 && (
          ...
          >
            ...
            <ModalContent
              className="absolute bg-popover border border-border rounded-2xl p-0"
              style={{
        ...
        <Modal isOpen={showThemeMenu} onClose={() => setShowThemeMenu(false)}>
          <ModalBackdrop
            ...
            <View className="gap-5">
              ...
              <View className="items-center px-4 py-3 bg-secondary/50 rounded-xl">
                <Text className="text-foreground font-medium text-sm">
                  {currentThemeConfig.displayName} • {isDark ? 'Dark' : 'Light'}
                </Text>
