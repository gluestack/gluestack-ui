...
>(
  (
    { className, showOutsideDays = true, mode, selected, onSelect, ...props },
    ref
  ) => {
    const defaultClassNames = getDefaultClassNames();

    // Map our mode to react-day-picker mode
    const dayPickerMode =
      mode === 'range' ? 'range' : mode === 'multiple' ? 'multiple' : 'single';

    // Prepare props based on mode to satisfy TypeScript
