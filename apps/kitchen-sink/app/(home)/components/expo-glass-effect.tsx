...
return (
    <View className="w-72 rounded-2xl overflow-hidden">
      ...
      <View className="p-4">
        <GlassContainer spacing={8} className="rounded-2xl">
            ...
            <GlassView className="p-4 rounded-xl">
              <HStack className="gap-3 items-center">
                <VStack className="gap-0.5">
                  ...
                  <Text className="text-white/70 text-sm">3 new alerts</Text>
                </VStack>
              </HStack>
            </GlassView>
            <GlassView className="p-4 rounded-xl">
              <HStack className="gap-3 items-center">
                <VStack className="gap-0.5">
                  ...
                  <Text className="text-white/70 text-sm">2 unread</Text>
                </VStack>
              </HStack>
            </GlassView>
          </VStack>
...
return (
    <View className="w-72 h-40 rounded-2xl overflow-hidden">
      ...
      <View className="flex-1 flex-row items-center justify-center gap-3 px-4">
        <GlassView colorScheme="light" className="flex-1 h-24 rounded-xl items-center justify-center gap-1">
          <Text className="text-white font-semibold text-sm">Light</Text>
          <Text className="text-white/70 text-xs">Always light</Text>
        </GlassView>
        <GlassView colorScheme="dark" className="flex-1 h-24 rounded-xl items-center justify-center gap-1">
          <Text className="text-white font-semibold text-sm">Dark</Text>
          <Text className="text-white/70 text-xs">Always dark</Text>
        </GlassView>
        <GlassView colorScheme="auto" className="flex-1 h-24 rounded-xl items-center justify-center gap-1">
    ...
    <View className="w-72 h-44 rounded-2xl overflow-hidden">
      ...
      <View className="flex-1 flex-row items-center justify-center gap-4 px-5">
        <GlassView
          ...
          className="flex-1 h-28 rounded-2xl items-center justify-center gap-1.5"
        >
          <Text className="text-white font-semibold">Regular</Text>
          <Text className="text-white/70 text-xs text-center">Frosted</Text>
        </GlassView>
        <GlassView
        ...
        >
          ...
          <Text className="text-white/70 text-xs text-center">Transparent</Text>
        </GlassView>
      </View>
    </View>
  )
