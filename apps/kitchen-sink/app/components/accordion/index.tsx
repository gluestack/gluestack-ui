            ...
            >
              <AccordionItem value="a" className="border-b border-outline-300">
                  ...
                  <AccordionTrigger>
                    {({ isExpanded }) => {
                      return (
                        <>
                          <AccordionTitleText>
                            What does the "type" prop of the Accordion component
                            do?
                          </AccordionTitleText>
                          {isExpanded ? (
                ...
                <AccordionContent className="mt-0 pt-2 bg-background-50">
                  <AccordionContentText>
                    The type prop determines whether one or multiple items can
                    be opened at the same time. The default value is "single"
                    which means only one item can be opened at a time.
                  </AccordionContentText>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="c">
                ...
                <AccordionContent className="mt-0 pt-2 bg-background-50">
                  <AccordionContentText>
                    Controlled components refer to the components where the
                    state and behaviors are controlled by the Parent component.
                    You can make the accordion a controlled component by passing
                    the value prop to the Accordion component and setting the
                    onValueChange prop to update the value prop. Refer to the
              ...
              <AccordionItem value="item-2">
                ...
                <AccordionContent>
                  <AccordionContentText>
                    ...
                    design pattern. You can read more about it in the
                    accessibility section of the docs.
                  </AccordionContentText>
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          ...
          return (
            ...
            >
              ...
              <AccordionItem value="item-2" className="rounded-lg">
                ...
                <AccordionContent>
                  <AccordionContentText>
                    The Accordion component has three size variants - sm, md and
                    lg.
                  </AccordionContentText>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-3" className="rounded-lg">
                ...
                <AccordionContent>
                  <AccordionContentText>
                    Yes, you can nest your accordions. Refer to the nested
                ...
                <AccordionContent className="pb-0">
                  <Accordion className="w-full border border-outline-300">
                    <AccordionItem value="b">
                      ...
                      <AccordionContent>
                        <AccordionContentText>
                          Capital city of California is Sacramento. California
                          has a GDP of 2.89 trillion dollars and follows Pacific
                          Standard Time zone.
                        </AccordionContentText>
                      </AccordionContent>
                    </AccordionItem>
                  ...
                  <Accordion className="w-full mt-5 bg-background-0">
                    <AccordionItem value="c">
                      ...
                      <AccordionContent>
                        <AccordionContentText>
                          Nevada is located in a mountainous region that
                          includes vast semiarid grasslands and sandy alkali
                          deserts. It is the most arid state of the country.
                        </AccordionContentText>
                      </AccordionContent>
                    </AccordionItem>
                  </Accordion>
          ...
          return (
            ...
            >
              ...
              <AccordionItem value="item-2">
                ...
                <AccordionContent>
                  <AccordionContentText>
                    Indulge your senses in a culinary adventure. Uncover the
                    secrets behind delectable dishes, learn about unique flavor
                    profiles, and ignite your passion for cooking.
                  </AccordionContentText>
                </AccordionContent>
              </AccordionItem>
              <AccordionItem
              ...
              >
                ...
                <AccordionContent>
                  <AccordionContentText>
                    ...
                    artistic potential, whether it's through writing, painting,
