                  ...
                  >
                    <VStack>
                      ...
                      <Text className="pt-2 text-typography-950" size="sm">
                        Upgrade your plan before your trial ends yo get 5%
                        discount. Use code{' '}
                ...
                <AlertDialogContent className="w-full max-w-[415px] gap-4 items-center">
                  ...
                  <AlertDialogBody>
                    <Text size="sm" className="text-center">
                      The invoice will be deleted from the invoices section and
                      in the documents folder. This cannot be undone.
                    </Text>
                  </AlertDialogBody>
