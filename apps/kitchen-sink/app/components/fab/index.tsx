            ...
            <Box className="max-w-96 border rounded-lg border-outline-200 overflow-hidden mx-5 bg-background-100">
              ...
              <VStack className="px-6 pt-4 pb-6">
                ...
                <Text className="my-1.5 text-xs">
                  Oranges are a great source of vitamin C, which is essential
                  for a healthy immune system. Oranges are a great source of
                  vitamin C, which is important for maintaining a healthy immune
                  system. Vitamin C also helps with the absorption of iron and
                  the production of collagen, which supports healthy skin,
                  teeth, and bones.
                </Text>
