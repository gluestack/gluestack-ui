...
const StyledH1 = withUniwind(H1);
const StyledH2 = withUniwind(H2);
const StyledH3 = withUniwind(H3);
const StyledH4 = withUniwind(H4);
const StyledH5 = withUniwind(H5);
const StyledH6 = withUniwind(H6);
