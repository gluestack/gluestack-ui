...
<HStack className="gap-3 items-center">
  <Box className="h-8 w-8 rounded-full overflow-hidden">
    <Image
      source={{ uri: "https://pbs.twimg.com/profile_images/1755143257229541377/tcB6c2VV_400x400.jpg" }}
...
<br />
<Image
  source={{ uri: "https://gluestack.github.io/public-blog-video-assets/variablescolorpalette.png" }}
...
<br />
<Image
  source={{ uri: "https://gluestack.github.io/public-blog-video-assets/framescolorpalette.png" }}
...
<br />
<Image
  source={{ uri: "https://gluestack.github.io/public-blog-video-assets/framesbrowncolorpalette.png" }}
  className="w-full h-[140px]"
  resizeMode="contain"
/>
<br />
...
<br />
<Image
  source={{ uri: "https://gluestack.github.io/public-blog-video-assets/semanticcolorpalette.png" }}
...
<br />
<Image
  source={{ uri: "https://gluestack.github.io/public-blog-video-assets/framesbigcolorpalette.png" }}
  className="w-full h-[340px]"
  resizeMode="contain"
/>
<br />
...
<br />
<Image
  source={{ uri: "https://gluestack.github.io/public-blog-video-assets/Do's&Dont'scolorpalette.png" }}
  className="w-full h-[340px]"
  resizeMode="contain"
/>
<br />
...
<br />
<Image
  source={{ uri: "https://gluestack.github.io/public-blog-video-assets/Do'scolorpalette.png" }}
  className="w-full h-[340px]"
  resizeMode="contain"
/>
<br />
