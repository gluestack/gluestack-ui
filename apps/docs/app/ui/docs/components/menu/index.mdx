...
```tsx
<!-- Failed to load file: core-components/nativewind/menu/index.tsx  --> 
```
...
#### Menu with Tag
A menu with items that include tags or badges.
...
#### Menu with Selection
A menu that supports item selection with icons.
