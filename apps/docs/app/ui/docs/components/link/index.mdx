...
```tsx
<!-- Failed to load file: core-components/nativewind/link/index.tsx  --> 
```
...
<TableBody>
  ...
  <TableRow>
    <TableCell><InlineCode>isExternal</InlineCode></TableCell>
  ...
  <TableRow>
    ...
    <TableCell>xs | sm | md | lg | xl | 2xl | 3xl | 4xl | 5xl | 6xl</TableCell>
...
#### Default Link
The Link component provides a simple way to create hyperlinks in your application.
...
#### Link with Icon
The Link with Icon variant adds a visual element to your links, making them more engaging and intuitive.
