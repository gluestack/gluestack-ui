    ...
    <Box className="justify-center max-w-[1440px] w-[85%] my-0 mx-auto relative border-t border-outline-100 mt-[60px] ">
      <VStack className="pt-12 pb-7 mb-5 md:pb-12 md:mb-0">
        <HStack className="flex-1 flex-wrap">
          <VStack className="mb-9 xl:mb-0 flex-1 md:min-w-[400px]">
            <Link href="/" className="no-underline mb-2">
              <Image
                alt="dark mode"
                className="w-[153px] h-[28px]"
                size="md"
                src={colorMode === 'light' ? GluestackLogo : GluestackLogoDark}
                // src={require('../../../../public/svg/gluestack_logo.svg')}
              />
            </Link>
            ...
            <HStack className="items-center gap-1 mt-4 self-start">
              ...
              >
                <Image
                  ...
                  size="md"
                  src={
                    colorMode === 'light' ? GeekyAntsLogo : GeekyAntsLogoDark
                  }
                />
              </Link>
            </HStack>
