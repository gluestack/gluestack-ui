  ...
  return (
    <VStack className="gap-20 flex-1 mt-[120px]">
      <VStack className="gap-3">
        <Heading
          size="2xl"
          className="text-3xl font-bold sm:leading-[54px] leading-9 mb-3 text-typography-900 sm:text-4xl"
        >
      ...
      <VStack className="gap-6">
        <HStack className="justify-between">
          <Box className="gap-1 justify-center md:flex hidden flex-row">
          ...
          <HStack className="bg-background-50 rounded-lg p-1 gap-1.5 items-center">
        ...
        {/* <ThemeProvider mode={themeMode}> */}
          <HStack className="gap-6">
            <VStack className="gap-6 xl:w-2/3">
              {/* Content for 1st column */}
              <HStack className="gap-6 md:flex-row flex-col w-full">
                {/* 1st */}

                <VStack className="gap-6 xl:flex hidden xl:w-[45%] md:w-1/2">
                  <VStack
                  ...
                  >
                    <Box className="w-full h-full min-h-[230px]">
                      <NextImage
                        alt="dark mode"
                        layout="fill"
                        objectFit="cover"
                    ...
                    <VStack className="self-start">
                      ...
                      <Text className="mt-1.5 self-start text-sm font-normal leading-[21px] text-typography-700">
                        Discover how the power of positive thinking can
                        transform your life, boost your confidence, and help you
                        overcome challenges. Explore practical tips and
                        techniques to cultivate a positive mindset for greater
                        happiness and success.
                      </Text>
                    </VStack>

                    <HStack className="self-start h-full" space="md">
                ...
                {/* 2 */}
                <VStack className="gap-6 xl:w-[55%] md:w-1/2">
                  <Box
              ...
              {/* 3 */}
              <Box
                className={`md:items-center xl:flex hidden items-start md:flex-row flex-col justify-between p-5 border border-outline-100 ${getBorderStyle(
                  activeButton,
                  ''
                )}`}
              >
            ...
            {/* 4 */}
            <Box className="gap-6 xl:flex hidden xl:w-1/3">
              <VStack
                className={`${getBorderStyle(
                  activeButton,
                  ''
                )} border-outline-100 border p-5 gap-8`}
              >
