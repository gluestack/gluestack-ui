...
import GluestackLogo from '@/public/logo/products/gluestack/gluestack-v4-logo.svg';
import GluestackLogoDark from '@/public/logo/products/gluestack/logo-dark.svg';
...
const Header = ({
  ...
  // Theme management - uses cookies for SSR, no client context needed for other components
